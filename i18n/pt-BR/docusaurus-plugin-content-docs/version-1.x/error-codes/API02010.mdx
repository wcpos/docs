...
# API02010: Autenticação Necessária {#api02010-auth-required}
...
### 2. Verifique o Status da Sessão {#2-check-session-status}
...
### 3. Verifique a Configuração do Servidor {#3-verify-server-configuration}
...
### 4. Verifique Problemas no Navegador/App {#4-check-for-browserapp-issues}
...
## O Que Requer Autenticação? {#what-requires-authentication}
