...
# API04005: Tentativa de Recuperação de JSON {#api04005-json-recovery-attempted}
...
### 1. Desativar Exibição de Erros do PHP {#1-disable-php-display-errors}
...
### 2. Ativar Registro de Erros em Seu Lugar {#2-enable-error-logging-instead}
...
### 3. Verificar o Modo de Depuração do Plugin {#3-check-for-plugin-debug-mode}
...
### 4. Revisar Mudanças Recentes {#4-review-recent-changes}
