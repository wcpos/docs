...
# API04001: Formato de Resposta Inválido {#api04001-invalid-response-format}
...
### 1. Verifique Seu Site {#1-check-your-site}
...
### 2. Verifique por Erros de PHP {#2-check-for-php-errors}
...
### 3. Teste a API REST Diretamente {#3-test-the-rest-api-directly}
...
### 4. Desative o Cache Temporariamente {#4-disable-caching-temporarily}
...
### 5. Verifique Conflitos de Plugin {#5-check-for-plugin-conflicts}
