...
<LinkCards>
  ...
  <LinkCard
    ...
    description="Pagamentos por celular via QR code ou notificação push. Vipps (Noruega), MobilePay (Dinamarca, Finlândia)."
    icon="mobile"
  />
  <LinkCard
    to="/payment/gateways/email-invoice"
    title="Fatura por E-mail"
    description="Envie ao cliente um link de pagamento por e-mail para finalizar o pedido online."
    icon="envelope"
  />
</LinkCards>
...
<LinkCards>
  ...
  <LinkCard
    to="/extensions/wpml"
    title="WCPOS WPML"
    description="Integração com WPML — filtre os produtos do POS para um único idioma."
    icon="globe"
  />
  <LinkCard
    to="/extensions/wp-multilang"
    title="WCPOS WP Multilang"
    description="Integração com WP Multilang — filtre os produtos do POS para um único idioma."
    icon="globe"
  />
</LinkCards>
...
<LinkCards>
  <LinkCard
    ...
    description="Resgate créditos de loja do StoreApps Smart Coupons no WCPOS, com rótulos de saldo no recibo e histórico de auditoria nas notas do pedido."
    icon="gift"
  />
</LinkCards>
...
<LinkCards>
  <LinkCard
    ...
    description="Vincule as lojas do WCPOS Pro aos locais do ATUM Multi-Inventory para estoque, preços e SKUs por localização."
    icon="box"
  />
</LinkCards>
