...
- Se você usa um terminal com fechamento manual de lote, **feche o lote agora**, antes de ir embora. Gateways integrados como o Stripe Terminal fecham automaticamente. Para configuração do Square via Web Checkout, consulte [Web Checkout](/payment/custom-gateways/web-checkout).
