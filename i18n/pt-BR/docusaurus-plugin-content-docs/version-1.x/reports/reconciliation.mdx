...
- Se você usa um terminal com fechamento manual de lote, **feche o lote agora**, antes de ir embora. Gateways integrados como o Stripe Terminal fecham automaticamente. Para configuração do Square via Checkout Web, consulte [Checkout Web](/payment/gateways/web-checkout).

</StepCard>
  <StepCard number="6" title="Imprimir o relatório">

Na tela de Relatórios, no painel Resumo, clique em **Imprimir**. Normalmente, isso utiliza o roteamento de impressão configurado (consulte [Roteamento de Impressão](/hardware/printers#print-routing)) para enviar o relatório a uma impressora de recibos ou documentos e produz um registro em papel.
