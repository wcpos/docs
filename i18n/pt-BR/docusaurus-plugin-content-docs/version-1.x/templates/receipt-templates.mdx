...
O editor de Modelos de Recibo permite que você customize a aparência e o conteúdo dos recibos impressos a partir do seu sistema POS. Você pode acessar o editor de modelos navegando até: `WP Admin > POS > Templates`

## Visão Geral

O sistema de modelos fornece dois tipos de modelos:

- **Modelos Padrão**: Detectados automaticamente a partir dos arquivos do seu plugin e tema. Esses não podem ser deletados, mas podem ser copiados para criar versões personalizadas.
...
- **Pré-visualizar**: Veja como o modelo parece com dados de amostra
...
- **Status**: Gestão do status Publicado/Rascunho
- **Visibilidade**: Controle sobre a visibilidade do modelo

### Ações do Modelo

- **Pré-visualizar**: Veja como seu modelo renderiza com dados de amostra
