...
### Fontes de Modelos {#template-sources}

| Fonte          | Descrição                                         | Status                               |
| -------------- | ------------------------------------------------- | ------------------------------------ |
| **Plugin**     | Modelo de recibo padrão incluído com o WCPOS | Sempre disponível                    |
| **Plugin Pro** | Modelo aprimorado incluso no WCPOS Pro  | Disponível com licença ativa         |
...
### Método 1: Copiar de um Modelo Padrão {#method-1-copy-from-default-template}
...
### Funções do WCPOS {#wcpos-functions}
...
### Integração com o Tema {#theme-integration}
