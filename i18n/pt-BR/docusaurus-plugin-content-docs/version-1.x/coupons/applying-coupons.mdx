...
### Quando os cupons não podem ser combinados {#when-coupons-cant-stack}
...
<Accordion>
  <AccordionItem question="Desconto do gerente — 10% avulso com um código rastreado">
...
Compartilhe o código apenas com os gerentes. O cupom aparece nos relatórios do WooCommerce como um desconto rastreado, diferentemente de uma [substituição de preço no POS](/pos/cart/discounts), que simplesmente reduz o preço do item.
  ...
  <AccordionItem question="Recompensa de fidelidade — $5 de desconto para clientes recorrentes">
...
No caixa, pesquise "fidelidade" para encontrá-lo sem precisar lembrar do código.
  ...
  <AccordionItem question="Promoção de uso único — folheto ou campanha impressa">
...
Para promoções de uso múltiplo em que cada cliente deve resgatar apenas uma vez, defina tanto o **Limite de uso por cupom** *quanto* o **Limite de uso por usuário: 1**.
  ...
  <AccordionItem question="Acumular um desconto do gerente sobre um código de cupom que o cliente trouxe">
...
Se o cupom do cliente estiver marcado como **Apenas uso individual**, o código do gerente será rejeitado. Remova o cupom do cliente primeiro (e reaplique depois, se necessário) ou atualize o cupom do cliente no WP Admin para permitir o acúmulo.
  ...
  <AccordionItem question="Um cliente quer devolver parte de um pedido e refazê-lo com um cupom diferente">
...
- **A finalização da venda pode funcionar offline** com um método de pagamento compatível com o modo offline. O pedido entra na fila localmente; o servidor revalida o cupom e atualiza sua contagem de uso quando o pedido chega ao WooCommerce.
