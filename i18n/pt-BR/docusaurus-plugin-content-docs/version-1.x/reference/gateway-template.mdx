...
- **[Fatura por Email](/payment/gateways/email-invoice)** — Envia um email de fatura para que o cliente possa pagar depois
- **[Checkout Web](/payment/gateways/web-checkout)** — Redireciona para a loja web para pagamento