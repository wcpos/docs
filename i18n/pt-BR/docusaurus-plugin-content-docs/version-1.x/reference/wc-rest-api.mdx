...
## Visualizando os Dados JSON no PDV {#viewing-the-json-data-in-the-pos}
...
<div class="image-container">
  <Image
    alt="Editando um item da linha no PDV"
    img="/img/edit-line-item.png"
    style={{ maxHeight: 400 }}
  />
  <p class="image-caption">Visualizando os dados JSON para um item da linha no PDV</p>
</div>
...
## Por Que Alguns Plugins Não Funcionam no PDV? {#why-dont-some-plugins-work-in-the-pos}
...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      cliente logado, o PDV não verá automaticamente esse preço personalizado.
    </td>
  </tr>
  <tr>
    <td>Complementos de Produto</td>
    <td>
      Se outro plugin em sua loja adicionar dados extras de produto, o PDV não
      verá automaticamente esses dados. O PDV apenas obtém os dados que são expostos
      através da API REST.
    </td>
  </tr>
</table>
