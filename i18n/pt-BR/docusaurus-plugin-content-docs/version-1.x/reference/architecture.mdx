...
- O _mundo JavaScript_ replica sua loja WooCommerce localmente, otimizado para pesquisas rápidas e uso offline.
...
Embora isso possa ser demorado inicialmente, uma vez baixados, eles ficam disponíveis instantaneamente sem a necessidade de buscar continuamente do servidor.
...
O plugin PHP estende a API REST do WooCommerce com endpoints adicionais para funcionalidades específicas do POS. Veja a [API REST do WooCommerce](/reference/wc-rest-api) para detalhes.