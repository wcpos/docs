...
- Contagem de pedidos com botão de sincronização (<Icon name="arrow-rotate-right" />). **Pressione e segure** para a opção Limpar e Atualizar
...
Clique no ícone de controle deslizante (<Icon name="sliders" />) para customizar as colunas visíveis.
