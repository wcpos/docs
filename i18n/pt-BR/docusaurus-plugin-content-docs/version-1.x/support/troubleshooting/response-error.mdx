---
title: Solução de Problemas "Cannot read properties of undefined (reading 'data')"
sidebar_label: Erro de Resposta
description: "Corrija o erro “Cannot read properties of undefined” no WCPOS causado por respostas vazias do servidor ou conflitos de plugins."
---
...
O registro de atividades do POS em [**Saúde da loja → Logs**](/support/logs) também pode conter informações de erro relevantes e códigos de erro que podem ajudar a identificar o problema.
