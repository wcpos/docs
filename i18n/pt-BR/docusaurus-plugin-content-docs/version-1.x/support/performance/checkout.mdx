...
O checkout do WCPOS abre um modal com um iframe/webview que carrega uma versão simplificada do template de Pagamento de Pedidos do WooCommerce. Esta é essencialmente a mesma página que os clientes veem ao pagar pelos pedidos online, a [Página de Pagamento do Cliente](https://woocommerce.com/document/managing-orders/paying-for-orders/#customer-payment-page-link).
...
- **Template simplificado** - Remove elementos de tema desnecessários e desordem
...
2. **Teste a velocidade do checkout** - Processem um pedido de teste e anote o desempenho
