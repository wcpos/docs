...
sidebar_position: 1
description: Solucione tempos de checkout lentos no WCPOS analisando tempos de execução e identificando gargalos.
---
...
O checkout do WCPOS abre um modal com um iframe/webview que carrega uma versão simplificada do template de Pagamento de Pedido do WooCommerce. Esta é essencialmente a mesma página que os clientes veem na [Página de Pagamento do Cliente](https://woocommerce.com/document/managing-orders/paying-for-orders/#customer-payment-page-link) ao pagar por pedidos online.
