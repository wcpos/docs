...
## Explicação da Carga do Servidor
...
As médias de carga do servidor nem sempre se correlacionam diretamente com a performance. Um servidor com altos valores de carga (15+) ainda pode ser muito responsivo se tiver recursos suficientes e estiver bem otimizado. **Concentre-se nos tempos de execução em vez de apenas nos valores de carga.**
:::
...
- **Monitoramento em horários de pico** - Monitorar durante períodos de alta tráfico
