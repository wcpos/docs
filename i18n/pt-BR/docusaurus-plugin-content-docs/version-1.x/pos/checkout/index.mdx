...
Quando você estiver pronto para completar uma venda, clique no botão **Checkout** para abrir o modal de checkout. É aqui que você processa o pagamento e finaliza o pedido.
...
- **Dinheiro** - Com cálculo de valor recebido e troco
...
No entanto, scripts de tema e plugin podem às vezes interferir. Clique em **Configurações de Checkout** para solucionar problemas:
