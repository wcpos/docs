...
O WCPOS armazena os pedidos no banco de dados local do dispositivo. Isso proporciona:
...
## Anulando Pedidos {#voiding-orders}
...
- Você pode concluir um pedido com um método de pagamento compatível com o modo offline; gateways que dependem do servidor permanecem indisponíveis até que seus serviços estejam acessíveis
