...
Daten werden von WooCommerce über die [WooCommerce REST API](https://woocommerce.github.io/woocommerce-rest-api-docs/) abgerufen. Das bedeutet, dass das POS jedes Produkt, jede Variation, jede Produktkategorie, jeden Kunden, jeden Steuersatz und mehr herunterladen muss, um sie lokal zu speichern.
...
Das PHP-Plugin erweitert die WooCommerce REST API mit zusätzlichen Endpunkten für POS-spezifische Funktionen. Siehe [WooCommerce REST API](/reference/wc-rest-api) für Details.
