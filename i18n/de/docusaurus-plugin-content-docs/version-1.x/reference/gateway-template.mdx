...
- **[E-Mail-Rechnung](/payment/gateways/email-invoice)** — Sendet eine Rechnungs-E-Mail, damit der Kunde später bezahlen kann
- **[Web-Checkout](/payment/gateways/web-checkout)** — Leitet zum Webshop für die Zahlung weiter