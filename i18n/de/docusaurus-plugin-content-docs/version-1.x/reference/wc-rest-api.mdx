...
<div class="image-container">
  <Image
    alt="Netzwerkinspektor im Browser"
    img="/img/network-inspector.png"
  />
  <p class="image-caption">Netzwerkinspektor im Browser</p>
</div>
...
<table>
  ...
  <tr>
    ...
    <td>
      Wenn ein anderes Plugin in Ihrem Shop einen einzigartigen Preis für jeden
  ...
  <tr>
    ...
    <td>
      Wenn ein anderes Plugin in Ihrem Shop zusätzliche Produktdaten hinzufügt,
