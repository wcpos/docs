...
Der Gutschein-REST-Endpunkt befindet sich im **kostenlosen Plugin** unter `/wp-json/wcpos/v1/coupons`, sodass die POS-App beim Abfragen von Gutscheinen niemals einen 404-Fehler erhält — auch auf Websites ohne installiertes WCPOS Pro. Die benutzerseitige Gutscheinfunktion selbst erfordert jedoch Pro.
