...
- Bei Verwendung eines Terminals mit manueller Batch-Abrechnung sollte **der Batch jetzt abgerechnet werden**, bevor der Arbeitstag beendet wird. Integrierte Zahlungsgateways wie Stripe Terminal rechnen automatisch ab. Informationen zur Square-Konfiguration über Web-Checkout finden Sie unter [Web-Checkout](/payment/gateways/web-checkout).

</StepCard>
  <StepCard number="6" title="Bericht drucken">

Im Zusammenfassungsbereich des Berichtsbildschirms auf **Drucken** klicken. Dabei wird in der Regel die konfigurierte Druckweiterleitung verwendet (siehe [Druckweiterleitung](/hardware/printers#print-routing)), um den Bericht an einen Beleg- oder Dokumentendrucker zu senden und einen Papierausdruck zu erstellen.
