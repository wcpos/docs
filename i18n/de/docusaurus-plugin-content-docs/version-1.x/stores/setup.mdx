...
:::info Pro-Funktion
Die Nutzung mehrerer Filialen erfordert [WCPOS Pro](/getting-started/pro-license). Ohne Pro läuft WCPOS als einzelne virtuelle Filiale, die aus den allgemeinen WooCommerce-Einstellungen zusammengestellt wird — es gibt keine Filialen-Seite.
:::

Diese Seite führt Schritt für Schritt durch das Erstellen einer Filiale. Für den konzeptionellen Überblick (was Multi-Filiale leistet, filialbasierte Preisgestaltung, ATUM-Integration) beginnen Sie mit [Multi-Filiale](/stores).
...
- [Multi-Store-Übersicht](/stores) — was Multi-Store bietet und wann es sinnvoll ist
