...
sidebar_position: 1
description: "Passen Sie WCPOS-Belegvorlagen mit HTML, CSS und Vorlagenvariablen für gedruckte und per E-Mail versandte Belege an."
---

import Accordion from '@site/src/components/Accordion';
import AccordionItem from '@site/src/components/AccordionItem';

Der Belegvorlagen-Editor ermöglicht es Ihnen, das Aussehen und den Inhalt von Belegen anzupassen, die von Ihrem POS-System gedruckt werden. Sie können den Vorlagen-Editor aufrufen, indem Sie zu: `WP Admin > POS > Vorlagen` navigieren.
...
| -------------- | --------------------------------------------------- | ------------------------------------ |
| **Plugin**     | Standard-Belegvorlage, die mit WooCommerce POS geliefert wird | Immer verfügbar                     |
| **Pro Plugin** | Verbesserte Vorlage von WooCommerce POS Pro          | Verfügbar bei aktivem Lizenz        |
...
### Methode 1: Kopieren von der Standardvorlage {#method-1-copy-from-default-template}
...
- **Vollbildbearbeitung**: Ablenkungsfreier Bearbeitungsbereich
...
### Vorlage Entwicklung {#template-development}
...
WooCommerce POS bietet verschiedene Hooks und Filter für die Vorlagenanpassung. Konsultieren Sie die Entwicklermokumentation für verfügbare Optionen.
