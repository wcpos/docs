---
title: "Belegdokumentvorlagen"
sidebar_label: "Belegdokumentvorlagen"
sidebar_position: 1
---

Der Belegdokumenteditor ermöglicht es Ihnen, das Erscheinungsbild und den Inhalt der von Ihrem POS-System ausgegebenen Belege anzupassen. Sie können den Template-Editor erreichen, indem Sie zu: `WP Admin > POS > Templates` navigieren.
...
Das System erkennt automatisch Belegdokumentvorlagen aus drei Quellen:

### Vorlagenquellen

| Quelle         | Beschreibung                                            | Status                               |
| -------------- | ------------------------------------------------------- | ------------------------------------ |
| **Plugin**     | Kernbelegdokumentvorlage, die mit WooCommerce POS geliefert wird | Immer verfügbar                      |
...
- **Sprache**: Auf PHP einstellen für richtiges Syntax-Highlighting
...
Belegdokumentvorlagen sind PHP-Dateien, die HTML-Ausgaben generieren. Hier ist die grundlegende Struktur:
...
- `get_bloginfo( 'name' )` - Geschäftsnamen
...
Sie können spezifische WCPOS-Funktionen (mit dem Präfix `wcpos_`) verwenden, um auf POS-bezogene Daten und Funktionen zuzugreifen.
...
Für fortgeschrittene Benutzer, die mehr Kontrolle über Belegdokumentvorlagen benötigen:
...
WooCommerce POS bietet verschiedene Hooks und Filter für die Anpassung von Vorlagen. Konsultieren Sie die Entwicklerdekumentation für verfügbare Optionen.

### Benutzerdefinierte Felder

Sie können benutzerdefinierte Bestellfelder, Produkteigenschaften und andere Metadaten in Ihren Belegdokumentvorlagen mithilfe geeigneter WordPress- und WooCommerce-Funktionen einfügen.