...
| -------------- | ----------------------------------------------------- | ------------------------------------ |
| **Plugin**     | Kernbelegvorlage, die mit WCPOS geliefert wird | Immer verfügbar                     |
| **Pro Plugin** | Erweiterte Vorlage von WCPOS Pro          | Verfügbar bei aktivem Lizenz         |
...
5. Konsultieren Sie die Dokumentation von WCPOS für erweiterte Anpassungen
