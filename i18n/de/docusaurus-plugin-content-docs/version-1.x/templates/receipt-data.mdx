...
## tax und tax_summary {#tax-and-taxsummary}
...
| `fiscal.is_reprint` | boolean | Ob es sich um einen Nachdruck handelt |
...
| `presentation_hints.timezone` | string | Zeitzone des Bons |
