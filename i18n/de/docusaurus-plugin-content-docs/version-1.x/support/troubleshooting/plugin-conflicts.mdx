...
- **Daten-Synchronisierungsprobleme** - Produkte, Bestellungen oder Kunden, die nicht ordnungsgemäß synchronisieren
...
1. **Überprüfen Sie die WCPOS-Protokolle** - Öffnen Sie den [Logs](/support/logs) Bildschirm in WCPOS auf Fehlermeldungen
2. **Überprüfen Sie die fatalen Fehlerprotokolle** - Folgen Sie dem [Critical Error troubleshooting guide](/support/troubleshooting/critical-error), um detaillierte Fehlermeldungen zu finden
...
3. **Erfassen Sie Leistungsmetriken** - Wenn es sich um ein Leistungsproblem handelt, notieren Sie die Ausführungszeiten aus den [Logs](/support/logs)
