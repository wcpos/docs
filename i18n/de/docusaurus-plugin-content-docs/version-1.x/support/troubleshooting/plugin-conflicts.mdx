...
2. **Überprüfen Sie die Logs für fatale Fehler** - Folgen Sie dem [Leitfaden zur Fehlersuche bei kritischen Fehlern](/support/troubleshooting/critical-error), um detaillierte Fehlermeldungen zu finden
...
<LinkCards>
  <LinkCard to="/support/troubleshooting/critical-error" title="Kritischer Fehler" description="So finden Sie fatale Fehlerprotokolle" />
