...
2. **Überprüfen Sie die fatalen Fehlerprotokolle** - Folgen Sie dem [Leitfaden zur Fehlersuche bei kritischen Fehlern](/support/troubleshooting/critical-error), um detaillierte Fehlermeldungen zu finden
...
3. **Erfassen Sie Leistungsmetriken** - Wenn es sich um ein Leistungsproblem handelt, notieren Sie die Ausführungszeiten aus den [Protokollen](/support/logs)
