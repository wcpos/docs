...
Die Serverlast steht für die durchschnittliche Systemlast über verschiedene Zeiträume:
...
2. Führen Sie die langsame Operation aus (Produkte synchronisieren, Bestellung erstellen, etc.)
