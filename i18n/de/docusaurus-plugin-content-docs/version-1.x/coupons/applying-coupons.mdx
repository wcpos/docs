---
title: Gutscheine an der Kasse einlösen
sidebar_label: Gutscheine einlösen
sidebar_position: 2
description: "Der Arbeitsablauf des Kassenpersonals zum Einlösen von WooCommerce-Gutscheinen an der WCPOS-Kasse — Suche, Gutschein-Chips, sequenzielle Rabatte und das Beheben von Validierungsfehlern."
---
...
:::info Pro-Funktion
Das Einlösen von Gutscheinen an der Kasse erfordert [WCPOS Pro](/getting-started/pro-license). Free-Nutzer sehen den [Gutscheine](/coupons)-Bildschirm als unscharfe Vorschau, die Aktion **Gutschein hinzufügen** ist im Warenkorb jedoch deaktiviert.
:::

Diese Seite behandelt den Arbeitsablauf an der Kasse — einen Gutschein finden, ihn anwenden, mehrere Gutscheine kombinieren und mit Fehlern umgehen. Für Gutscheinarten, Einrichtung und Validierungsregeln siehe [Gutscheine](/coupons); für spontane Rabatte, die eine Kassenkraft direkt erstellt, siehe [Warenkorbrabatte](/pos/cart/discounts).

## Der Ablauf zum Hinzufügen von Gutscheinen {#the-add-coupon-flow}

Unterhalb der Warenkorbpositionen befindet sich eine Schaltfläche **Gutschein hinzufügen**. Durch Tippen öffnet sich ein kleines Eingabefeld, in dem Sie entweder einen Code eingeben oder suchen können.

1. Tippen Sie im Warenkorb auf **Gutschein hinzufügen**
2. Beginnen Sie mit der Eingabe — das Eingabefeld dient gleichzeitig als Suche über alle synchronisierten Gutscheine (Code und Beschreibung)
3. Wählen Sie den Gutschein aus der Vorschlagsliste aus oder geben Sie den Code vollständig ein und drücken Sie **Enter**
...
### Wenn Gutscheine nicht kombiniert werden können {#when-coupons-cant-stack}
...
<Accordion>
  <AccordionItem question="Manager-Rabatt — spontane 10 % mit nachverfolgbarem Code">
...
Geben Sie den Code nur an Filialleiter weiter. Der Gutschein wird in den WooCommerce-Berichten als nachverfolgter Rabatt angezeigt – im Gegensatz zu einer [POS-Preisänderung](/pos/cart/discounts), die lediglich den Positionspreis reduziert.
  ...
  <AccordionItem question="Treueprämie — 5 $ Rabatt für Stammkunden">
...
An der Kasse nach „Treue“ suchen, um den Gutschein zu finden, ohne sich den Code merken zu müssen.
  ...
  <AccordionItem question="Einmal-Aktion — Flyer oder Printkampagne">
...
Bei Mehrfach-Aktionen, bei denen jeder Kunde nur einmal einlösen soll, sowohl **Verwendungsbeschränkung pro Gutschein** *als auch* **Verwendungsbeschränkung pro Benutzer: 1** festlegen.
  ...
  <AccordionItem question="Einen Manager-Rabatt zusätzlich zu einem vom Kunden mitgebrachten Gutscheincode anwenden">
...
Wenn der Gutschein des Kunden auf **Individuelle Verwendung** gesetzt ist, wird der Manager-Code abgelehnt. In diesem Fall entweder zuerst den Gutschein des Kunden entfernen (und bei Bedarf später erneut anwenden) oder den Gutschein des Kunden in WP Admin so aktualisieren, dass Kombinationen zulässig sind.
  ...
  <AccordionItem question="Ein Kunde möchte einen Teil einer Bestellung zurückgeben und mit einem anderen Gutschein neu erfassen">
...
- **Der Abschluss des Verkaufs kann offline erfolgen**, sofern eine offlinefähige Zahlungsmethode verwendet wird. Die Bestellung wird lokal in die Warteschlange gestellt; der Server validiert den Gutschein erneut und aktualisiert dessen Nutzungsanzahl, sobald die Bestellung WooCommerce erreicht.
