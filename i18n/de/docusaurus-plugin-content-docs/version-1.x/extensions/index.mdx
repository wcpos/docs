...
<LinkCards>
  <LinkCard
    ...
    title="DE: Stripe Terminal"
    description="DE: Vor-Ort-Kartenzahlungen mit Stripe Terminal-Hardware (S700, WisePOS E). Unterstützt MOTO- und Simulatormodus."
    icon="credit-card"
  />
  <LinkCard
    to="/payment/gateways/sumup-terminal"
    title="DE: SumUp Terminal"
    description="DE: Akzeptieren Sie Kartenzahlungen über SumUp-Kartenlesegeräte."
    icon="credit-card"
  />
  <LinkCard
    to="/payment/gateways/vipps-mobilepay"
    title="DE: Vipps MobilePay"
    description="DE: Telefonbasierte Zahlungen per QR-Code oder Push-Benachrichtigung. Vipps (Norwegen), MobilePay (Dänemark, Finnland)."
    icon="mobile"
  />
  <LinkCard
    to="/payment/gateways/email-invoice"
    title="DE: E-Mail-Rechnung"
    description="DE: Senden Sie dem Kunden einen Zahlungslink per E-Mail, um die Bestellung online zu begleichen."
    icon="envelope"
  />
</LinkCards>
...
<LinkCards>
  <LinkCard
    ...
    title="DE: WCPOS Polylang"
    description="DE: Polylang-Integration — sprachbewusste Produktsynchronisation und Sprachauswahl pro Filiale für WCPOS Pro."
    icon="globe"
  />
  <LinkCard
    to="/extensions/wpml"
    title="DE: WCPOS WPML"
    description="DE: WPML-Integration — POS-Produkte auf eine einzelne Sprache filtern."
    icon="globe"
  />
  <LinkCard
    to="/extensions/wp-multilang"
    title="DE: WCPOS WP Multilang"
    description="DE: WP-Multilang-Integration — POS-Produkte auf eine einzelne Sprache filtern."
    icon="globe"
  />
</LinkCards>
...
<LinkCards>
  <LinkCard
    ...
    title="DE: WCPOS StoreApps Smart Coupons"
    description="DE: StoreApps Smart Coupons-Ladenguthaben in WCPOS einlösen, mit Guthaben-Anzeige auf dem Beleg und Prüfverlauf in den Bestellnotizen."
    icon="gift"
  />
</LinkCards>
...
<LinkCards>
  <LinkCard
    to="/extensions/atum"
    title="DE: WCPOS ATUM-Integration"
    description="DE: WCPOS Pro-Filialen mit ATUM Multi-Inventory-Lagerorten verknüpfen für standortbezogenen Bestand, Preise und SKUs."
    icon="box"
  />
</LinkCards>
