...
# API04001: 잘못된 응답 형식 {#api04001-invalid-response-format}
...
### 2. PHP 오류 확인 {#2-check-for-php-errors}
...
### 3. REST API 직접 테스트 {#3-test-the-rest-api-directly}
...
### 4. 캐싱 임시 비활성화 {#4-disable-caching-temporarily}
