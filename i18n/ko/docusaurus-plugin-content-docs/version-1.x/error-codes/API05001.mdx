...
# API05001: WooCommerce API 비활성화 {#api05001-woocommerce-api-disabled}
...
### 1. WooCommerce REST API 활성화 {#1-enable-woocommerce-rest-api}
...
### 2. WordPress REST API 확인 {#2-check-wordpress-rest-api}
...
### 3. 보안 플러그인 확인 {#3-check-security-plugins}
