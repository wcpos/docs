...
3. Cloudflare에서 REST API 경로에 대한 WAF **건너뛰기** 규칙을 추가하세요. Free 요금제의 Bot Fight Mode는 어떤 규칙으로도 우회할 수 없으므로 꺼야 합니다. [Cloudflare 안내](/support/troubleshooting/cloudflare)에 정확한 규칙과 `curl` 확인 방법이 있습니다.
