---
title: "API05004: WordPress API 비활성화됨"
sidebar_label: API05004
---

# API05004: WordPress API 비활성화됨 {#api05004-wordpress-api-disabled}

## 의미 {#what-this-means}

사이트에서 WordPress REST API가 비활성화되어 있습니다. WooCommerce와 WCPOS를 비롯한 모든 최신 WordPress 기능은 이 API에 의존합니다.
...
### 3. 사용자 정의 코드 확인 {#3-check-for-custom-code}
...
### 4. .htaccess 확인 {#4-check-htaccess}
...
### 5. 호스팅 제공업체에 문의 {#5-contact-hosting-provider}
...
## REST API의 중요성 {#why-rest-api-matters}

WordPress REST API는 다음 항목에 필수입니다:
- 모바일 앱
- 타사 통합
- WooCommerce 기능
- WCPOS 운영
