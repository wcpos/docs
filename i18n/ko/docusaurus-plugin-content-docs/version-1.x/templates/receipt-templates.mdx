...
| 출처         | 설명                                         | 상태                               |
| -------------- | -------------------------------------------- | ---------------------------------- |
| **플러그인**     | WCPOS에 포함된 기본 영수증 템플릿 | 항상 사용 가능                     |
| **WCPOS Pro** | WCPOS Pro에서 제공하는 향상된 템플릿    | 활성화된 라이센스가 있는 경우 사용 가능 |
...
5. 고급 사용자 정의를 위해 WCPOS 문서를 참조하세요.
...
WCPOS는 템플릿 사용자 정의를 위한 다양한 후크 및 필터를 제공합니다. 사용 가능한 옵션에 대해 개발자 문서를 참조하세요.
