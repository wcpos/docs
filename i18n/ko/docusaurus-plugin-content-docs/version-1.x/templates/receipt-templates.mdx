...
sidebar_position: 1
description: "인쇄 및 이메일 영수증을 위한 HTML, CSS 및 템플릿 변수를 사용하여 WCPOS 영수증 템플릿을 사용자 정의하십시오."
---
...
| **Pro 플러그인**| WCPOS Pro의 향상된 템플릿                           | 활성 라이센스가 있는 경우 사용 가능      |
| **테마**       | 활성 테마에서 나온 사용자 정의 템플릿                    | 테마에 템플릿이 포함된 경우 사용 가능 |
...
## 사용자 정의 템플릿 만들기 {#creating-custom-templates}

### 방법 1: 기본 템플릿 복사 {#method-1-copy-from-default-template}
...
### 방법 2: 처음부터 만들기 {#method-2-create-from-scratch}
...
### 템플릿 작업 {#editor-template-actions}
...
WCPOS 관련 데이터 및 기능에 접근하기 위해 `wcpos_`로 시작하는 WCPOS 전용 함수를 사용할 수 있습니다.
...
<Accordion>
  <AccordionItem question="템플릿이 변경 사항을 표시하지 않음">
  ...
  <AccordionItem question="템플릿을 사용할 수 없음">
