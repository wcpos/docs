...
<Accordion>
  <AccordionItem question="게이트웨이가 POS에 표시되지 않음">
  ...
  <AccordionItem question="게이트웨이가 웹 결제에 표시됨">
  ...
  <AccordionItem question="주문이 'Completed' 대신 'Processing' 상태로 유지됨">
...
- **[이메일 인보이스](/payment/gateways/email-invoice)** — 고객이 나중에 결제할 수 있도록 인보이스 이메일을 발송합니다
- **[웹 결제](/payment/gateways/web-checkout)** — 결제를 위해 웹 스토어로 리디렉션합니다
