...
<LinkCards>
  ...
  <LinkCard
    ...
    title="SumUp 터미널"
    description="SumUp 카드 리더를 통해 카드 결제를 받습니다."
    icon="credit-card"
  />
  <LinkCard
    to="/payment/gateways/vipps-mobilepay"
    title="Vipps MobilePay 결제"
...
직접 구축하려면 [게이트웨이 템플릿](/reference/gateway-template)에서 시작하세요. 전체 목록은 [사용자 지정 게이트웨이 개요](/payment/gateways)를 참조하세요.
...
<LinkCards>
  <LinkCard
    ...
    title="WCPOS Polylang 통합"
    description="Polylang 통합 — WCPOS Pro용 언어별 상품 동기화 및 매장별 언어 선택."
    icon="globe"
  />
  <LinkCard
    to="/extensions/wpml"
...
<LinkCards>
  <LinkCard
    ...
    title="WCPOS StoreApps Smart Coupons 통합"
    description="영수증 잔액 라벨과 주문 메모 감사 기록을 포함해 WCPOS에서 StoreApps Smart Coupons 스토어 크레딧을 사용합니다."
    icon="gift"
  />
</LinkCards>
...
<LinkCards>
  <LinkCard
    to="/extensions/atum"
    title="WCPOS ATUM 통합"
    description="위치별 재고, 가격, SKU를 위해 WCPOS Pro 매장을 ATUM Multi-Inventory 위치에 연결합니다."
    icon="box"
  />
</LinkCards>
