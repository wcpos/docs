...
서버 부하 평균이 성능과 직접적으로 연관되지 않는 경우가 있습니다. 높은 부하 값(15+)을 가진 서버도 충분한 리소스가 있고 잘 최적화되어 있다면 매우 반응적일 수 있습니다. **부하 값만이 아닌 실행 시간에 집중하세요.**
:::

**일반 지침:**
- **CPU 코어에 대한 부하** - 8코어 서버의 8.0 부하는 완전 활용을 의미합니다.
- **지속적 vs. 일시적** - 짧은 급증은 정상이며, 지속적인 높은 부하는 문제를 나타낼 수 있습니다.
- **성능이 더 중요합니다** - 높은 부하의 반응적인 서버가 낮은 부하의 느린 서버보다 낫습니다.
