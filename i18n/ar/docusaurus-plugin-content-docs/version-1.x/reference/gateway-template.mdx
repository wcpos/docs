...
- **[الفاتورة عبر البريد الإلكتروني](/payment/gateways/email-invoice)** - ترسل بريدًا إلكترونيًا بالفاتورة حتى يتمكن العميل من الدفع لاحقًا
- **[الخروج عبر الويب](/payment/gateways/web-checkout)** - يعيد التوجيه إلى متجر الويب للدفع