---
title: "API05004: واجهة WordPress API معطلة"
sidebar_label: API05004
---

# API05004: واجهة WordPress API معطلة {#api05004-wordpress-api-disabled}

## ماذا يعني هذا {#what-this-means}

واجهة WordPress REST API معطلة على موقعك. تعتمد جميع وظائف WordPress الحديثة، بما فيها WooCommerce وWCPOS، على هذه الواجهة.
...
### 1. اختبار واجهة برمجة التطبيقات REST {#1-test-the-rest-api}
...
### 2. تحقق من إضافات الأمان {#2-check-security-plugins}
...
### 3. تحقق من الكود المخصص {#3-check-for-custom-code}
...
### 5. اتصل بمزود الاستضافة {#5-contact-hosting-provider}
...
## لماذا تعتبر واجهة برمجة التطبيقات REST مهمة {#why-rest-api-matters}

واجهة WordPress REST API أساسية لما يلي:
- التطبيقات المحمولة
