...
description: أنشئ بوابة الدفع الخاصة بك لـ WooCommerce POS
---
...
يتضمن القالب سكريبت يقوم تلقائيًا بتخصيص القالب لبوابتك المحددة:
...
3. **اتباع التعليمات**:
   - أدخل اسم بوابتك (مثلًا، "بوابة الدفع الخاصة بي")
   - أدخل شريحة البوابة (مثلًا، "my-payment")
   - قدم وصفًا
   - سيقوم السكريبت بتوليد مكون مخصص
...
3. **إعادة تسمية الملفات**:
   ...
   - حدث رؤوس الملفات ومعلومات المكون
