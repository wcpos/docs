...
<Accordion>
  ...
  **Oplossing:** configureer de beveiligingsplug-in om niet-geverifieerde toegang tot `/wp-json/wcpos/` en `/wp-json/wc/v3/` toe te staan, of schakel deze net lang genoeg uit om de eerste verbinding te voltooien.
  ...
  Controleer of er een versieverschil is tussen de app en de serverplug-in — de appwinkel kan een app-update hebben uitgerold terwijl de WCPOS-plug-in nog moet worden bijgewerkt (of andersom). Voor v1.10 moeten de app en de WCPOS-plug-in allebei op de **releaselijn v1.10** zitten, omdat de app de v2-synchronisatie-API van de plug-in gebruikt. Als slechts één van beide is bijgewerkt en verzoeken mislukken met `rest_no_route`, werk dan de andere helft bij.
