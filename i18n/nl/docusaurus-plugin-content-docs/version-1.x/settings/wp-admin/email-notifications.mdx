...
De instellingen bevinden zich op het scherm **Kassa** — ga naar **WP Admin > POS > Instellingen > Kassa**. De e-mailbedieningen staan boven de secties Order Status en Payment Gateways.
