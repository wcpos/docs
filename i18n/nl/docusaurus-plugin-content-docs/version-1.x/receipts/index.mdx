...
Begin bij **[Uw bon aanpassen](/receipts/customise)**. Daar ziet u de drie eenvoudigste manieren: een andere meegeleverde template kiezen, AI vragen om er een aanpassing aan te doen, of de template handmatig bewerken.
:::
...
Templates worden gerenderd met een gestandaardiseerde [payload met bongegevens](/receipts/receipt-data), met secties voor winkelinformatie, artikelregels, totalen, btw, betalingen, terugbetalingen en meer. Valutavelden bevatten allemaal vooraf opgemaakte `_display`-varianten, bijvoorbeeld `$29.99` in plaats van `29.99`.
