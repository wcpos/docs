...
3. Voeg in Cloudflare een WAF-regel **Skip** toe voor de REST API-paden. Bot Fight Mode (Free-abonnement) kan met geen enkele regel worden omzeild en moet worden uitgeschakeld. De [Cloudflare-handleiding](/support/troubleshooting/cloudflare) bevat de exacte regel en een `curl`-controle.
