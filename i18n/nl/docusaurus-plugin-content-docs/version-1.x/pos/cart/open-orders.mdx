...
WCPOS slaat bestellingen op in de lokale database op het apparaat. Dit biedt:
...
- Je kunt een bestelling voltooien met een betaalmethode die offline werkt; gateways die van de server afhankelijk zijn, blijven onbeschikbaar totdat hun diensten bereikbaar zijn
