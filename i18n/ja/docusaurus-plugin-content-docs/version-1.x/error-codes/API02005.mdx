...
# API02005: 権限が足りません {#api02005-insufficient-permissions}
...
### 1. 必要な機能の確認 {#1-review-required-capabilities}
...
### 2. ユーザーロールのアップグレード {#2-upgrade-user-role}

管理者により高度な役割を割り当てるよう頼んでください：
- **ショップマネージャー** — 完全なWooCommerceアクセス
- **管理者** — 完全なサイトアクセス

### 3. 特定の機能を追加 {#3-add-specific-capabilities}
...
### 4. プラグインの競合を確認 {#4-check-plugin-conflicts}
