...
# API05001: WooCommerce API が無効 {#api05001-woocommerce-api-disabled}
...
### 1. WooCommerce REST API を有効にする {#1-enable-woocommerce-rest-api}
...
### 2. WordPress REST API を確認 {#2-check-wordpress-rest-api}
...
### 3. セキュリティプラグインを確認 {#3-check-security-plugins}
...
### 4. .htaccess を確認 {#4-check-htaccess}
...
### 5. パーマリンクをフラッシュ {#5-flush-permalinks}
