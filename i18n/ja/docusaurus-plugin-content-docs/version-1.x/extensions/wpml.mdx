...
<Steps>
  <StepCard number="1" title="WPML をインストール">

[WPML](https://wpml.org/) を通常どおりインストール・設定し、少なくとも1つの言語をデフォルトとして設定してください。

  </StepCard>
  <StepCard number="2" title="WCPOS WPML のインストール">
...
<RequirementsList>
  <RequirementItem label="WooCommerce">WooCommerceがインストールおよび有効化されていること</RequirementItem>
  <RequirementItem label="WPML">WPMLがインストールされ、少なくとも1つの言語が設定されていること</RequirementItem>
