...
sidebar_position: 1
description: WCPOSのチェックアウトでの販売を完了する際に、支払い処理、分割払い、注文の完了を含みます。
---
...
### 追加ゲートウェイ <span class="badge badge--primary">Pro</span> {#additional-gateways-pro}
...
## クーポンコード <span class="badge badge--primary">Pro</span> {#coupon-codes}
