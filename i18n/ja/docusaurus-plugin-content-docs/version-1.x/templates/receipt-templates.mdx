...
sidebar_position: 1
description: "印刷されるレシートおよびメールで送信されるレシートのためにHTML、CSS、テンプレート変数を使用してWCPOSレシートテンプレートをカスタマイズします。"
---
...
| **Proプラグイン** | WCPOS Proからの拡張テンプレート              | アクティブライセンスで利用可能      |
...
1. **HTMLを検証する**: HTMLがよく形成されていることを確認
...
5. WCPOSドキュメントを参照して、詳細なカスタマイズを行う
...
WCPOSは、テンプレートカスタマイズのためのさまざまなフックおよびフィルターを提供します。利用可能なオプションについては開発者ドキュメントを参照してください。
