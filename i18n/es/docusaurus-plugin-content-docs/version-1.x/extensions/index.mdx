...
<LinkCards>
  <LinkCard
    ...
    description="Pagos con tarjeta presenciales mediante hardware Stripe Terminal (S700, WisePOS E). Compatible con modo MOTO y simulador."
    icon="credit-card"
  />
  <LinkCard
    to="/payment/gateways/sumup-terminal"
    title="SumUp Terminal"
    description="Aceptar pagos con tarjeta a través de lectores de tarjetas SumUp."
    icon="credit-card"
  />
  <LinkCard
  ...
  <LinkCard
    ...
    description="Enviar al cliente un enlace de pago por correo electrónico para completar el pedido en línea."
    icon="envelope"
  />
</LinkCards>
...
<LinkCards>
  ...
  <LinkCard
    to="/extensions/wpml"
    title="WCPOS WPML"
    description="Integración con WPML — filtra los productos del POS a un solo idioma."
    icon="globe"
  />
  <LinkCard
    to="/extensions/wp-multilang"
    title="WCPOS WP Multilang"
    description="Integración con WP Multilang — filtra los productos del POS a un solo idioma."
    icon="globe"
  />
</LinkCards>
...
<LinkCards>
  <LinkCard
    ...
    description="Canjea el crédito de tienda de StoreApps Smart Coupons en WCPOS, con etiquetas de saldo en el recibo e historial de auditoría en las notas del pedido."
    icon="gift"
  />
</LinkCards>
...
<LinkCards>
  <LinkCard
    to="/extensions/atum"
    title="Integración WCPOS con ATUM"
    description="Vincula las tiendas de WCPOS Pro con las ubicaciones de ATUM Multi-Inventory para gestionar stock, precios y SKU por ubicación."
    icon="box"
  />
</LinkCards>
