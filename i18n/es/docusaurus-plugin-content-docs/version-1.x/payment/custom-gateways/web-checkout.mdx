---
title: "Pasarela de Checkout Web"
description: "Completar pagos a través del proceso de checkout de la tienda web en WooCommerce POS"
---
...
# Pasarela de Checkout Web {#web-checkout-gateway}

La pasarela de Checkout Web permite a los clientes completar sus transacciones en el POS utilizando el sistema de checkout de tu tienda web. Esta pasarela crea un puente fluido entre tu POS en la tienda y los métodos de pago en línea, perfecto para situaciones donde los clientes prefieren pagar utilizando sus propios dispositivos o cuando necesitas acceso a métodos de pago solo en la web.
...
1. Visita la [página de lanzamientos de la Pasarela de Checkout Web](https://github.com/wcpos/web-checkout-gateway/releases)
...
2. Busca la **Pasarela de Checkout Web de WooCommerce POS** en la lista
...
### Iniciando el Checkout Web {#initiating-web-checkout}

1. **Agregar Artículos**: Agrega productos a tu carrito en el POS
2. **Seleccionar Pasarela**: Elige "Checkout Web" como el método de pago
...
1. **Monitorear Estado**: Mantén abierta la pantalla de pedidos del POS para monitorear el estado del pago
...
<UseCases>
  ...
  3. El personal selecciona la pasarela de Checkout Web
...
<Accordion>
  <AccordionItem question="Enlace de checkout no funciona">
...
### Optimización de Rendimiento {#performance-optimisation}
...
- Selección de la pasarela de Checkout Web y generación de enlaces en el POS
