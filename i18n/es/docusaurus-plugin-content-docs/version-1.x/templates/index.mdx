...
Comience en **[Personalizar el recibo](/templates/customise)**. Allí se describen las tres formas más sencillas de hacerlo: seleccionar una plantilla incluida diferente, pedir a la IA que la ajuste o editarla manualmente.
:::

## Motores de plantillas {#template-types}
...
| Recibo térmico simple (58 mm) | Thermal | Diseño térmico limpio de 58 mm |
| Recibo térmico simple (80 mm) | Thermal | Diseño térmico limpio de 80 mm, el más común |
| Recibo térmico simple 80 mm (RTL) | Thermal | Versión RTL para 80 mm. Requiere una impresora con página de códigos árabe (CP864 / Windows-1256) |
| Recibo térmico detallado (58 mm) | Thermal | 58 mm con todo incluido: direcciones, desglose de impuestos, reembolsos, pagos, condiciones y código de barras |
...
### Plantillas de documentos de terceros {#default-templates}
...
### Visualización adaptativa de impuestos {#custom-templates}
...
Las plantillas se renderizan a partir de un [payload de datos de recibo](/templates/receipt-data) estandarizado con secciones para información de la tienda, líneas de artículos, totales, impuestos, pagos, reembolsos y más. Todos los campos de moneda incluyen variantes `_display` con formato previo (por ejemplo, `$29.99` en lugar de `29.99`).
