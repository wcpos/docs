...
Si utiliza más de una plantilla — por ejemplo, un recibo térmico **y** una factura A4 — el enrutamiento de impresión decide en qué impresora se imprime cada plantilla. El enrutamiento tiene tres capas, que se comprueban en este orden:

1. **Anulación por trabajo.** En la pantalla del recibo, junto al selector de plantilla, hay un desplegable de impresora. Elegir una impresora aquí anula todo lo demás solo para ese trabajo de impresión. Al cambiar de plantilla, vuelve a **Automático**.
2. **Anulación en ajustes.** Vaya a **Ajustes → Enrutamiento de impresión** para asignar una impresora concreta a cada plantilla. Por ejemplo, puede enviar el recibo térmico a la impresora Epson de red y la factura HTML al diálogo de impresión del sistema. Cambie una plantilla de nuevo a **Automático** para quitar la anulación.
3. **Coincidencia automática.** Cuando no hay ninguna anulación, WCPOS realiza la coincidencia automáticamente:
   - Las **plantillas térmicas** se envían a impresoras térmicas cuyo ancho de caracteres coincida. Una plantilla térmica de 58 mm prefiere impresoras de 32 columnas; una plantilla de 80 mm prefiere impresoras de 42 o 48 columnas.
   - Las **plantillas HTML** se envían al diálogo de impresión del sistema.
   - Si coinciden varias impresoras, gana la impresora **predeterminada**.

Si envía manualmente una plantilla a una impresora incompatible — por ejemplo, una plantilla térmica al diálogo del sistema — aparece una **advertencia de incompatibilidad** ámbar en la pantalla del recibo. La impresión continúa, pero la salida puede no renderizarse correctamente.
...
:::note
La página Enrutamiento de impresión solo aparece cuando se ha añadido al menos una impresora. Sin impresoras configuradas, cada plantilla usa implícitamente el diálogo de impresión del sistema.
:::
