...
| -------------- | --------------------------------------------------- | ------------------------------------ |
| **Plugin**     | Plantilla de recibo básica incluida con WCPOS | Siempre disponible                     |
| **Pro Plugin** | Plantilla mejorada de WCPOS Pro           | Disponible con licencia activa        |
...
5. Consulte la documentación de WCPOS para personalización avanzada
...
WCPOS proporciona varios hooks y filtros para la personalización de plantillas. Consulte la documentación para desarrolladores para las opciones disponibles.
