...
<Accordion>
  ...
  - **Plugins de seguridad** — Wordfence, Really Simple Security, WPS Hide Login, iThemes/Solid Security y Defender Pro son los más habituales. Consulte la lista completa y las soluciones en [Conflictos de plugins](/support/troubleshooting/plugin-conflicts#security-and-login-plugins).
