...
3. En Cloudflare, añada una regla WAF **Omitir** para las rutas de la API REST; Bot Fight Mode (plan Free) no se puede omitir con ninguna regla y debe desactivarse. La [guía de Cloudflare](/support/troubleshooting/cloudflare) incluye la regla exacta y una comprobación con `curl`.
