...
# API02010: Autenticación Requerida {#api02010-auth-required}
...
### 2. Verificar el Estado de la Sesión {#2-check-session-status}
...
### 3. Verificar la Configuración del Servidor {#3-verify-server-configuration}
...
### 4. Verificar Problemas del Navegador/App {#4-check-for-browserapp-issues}
...
## Qué Requiere Autenticación? {#what-requires-authentication}
