...
# API05001: API de WooCommerce deshabilitada {#api05001-woocommerce-api-disabled}
...
### 1. Habilitar API REST de WooCommerce {#1-enable-woocommerce-rest-api}
...
### 2. Comprobar la API REST de WordPress {#2-check-wordpress-rest-api}
...
### 3. Comprobar plugins de seguridad {#3-check-security-plugins}
...
### 4. Comprobar .htaccess {#4-check-htaccess}
...
### 5. Actualizar enlaces permanentes {#5-flush-permalinks}
