...
## Lo que cada rol predeterminado puede hacer, de un vistazo {#what-each-default-role-can-do-at-a-glance}
...
Para el desglose completo por endpoint — incluidos los endpoints del plugin Pro, el comportamiento de expiración de tokens y consejos para distinguir los fallos de capacidad de los fallos de token — consulta la [referencia de Acceso a Endpoints por Rol](/reference/role-endpoint-access).