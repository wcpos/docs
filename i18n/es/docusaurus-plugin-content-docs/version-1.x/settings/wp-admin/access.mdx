...
| Gerente de Tienda | WooCommerce   | Este rol está diseñado para usuarios que necesitan acceso al POS y la capacidad de gestionar la configuración del POS. Los Gerentes de Tienda pueden no tener permiso para instalar plugins o realizar otras tareas administrativas.                                                                                                                                       |
...
| Capacidad                     | Descripción                                                         | Uso de Ejemplo                                                                                                                                         |
| ------------------------------ | ------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
| `manage_woocommerce_pos`       | Habilita la gestión de la configuración y ajustes de WCPOS.       | Habilitar esta opción daría al cajero la capacidad de modificar configuraciones relacionadas con el POS, como métodos de pago o plantillas de recibos. |
