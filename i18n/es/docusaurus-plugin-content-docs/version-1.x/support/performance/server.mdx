...
WCPOS recopila automáticamente métricas de rendimiento del servidor con cada operación de captura de datos (productos, pedidos, clientes, etc.). Puedes ver estas métricas en la pantalla de [Registros](/support/logs).
...
<LinkCards>
  ...
  <LinkCard to="/support/performance/checkout" title="Rendimiento de Checkout" description="Optimiza el procesamiento de pagos" />
