...
El checkout de WCPOS abre un modal con un iframe/webview que carga una versión reducida de la plantilla de Pago de Pedidos de WooCommerce. Esta es esencialmente la misma página que los clientes ven cuando pagan por pedidos en línea, la [página de Pago del Cliente](https://woocommerce.com/document/managing-orders/paying-for-orders/#customer-payment-page-link).
