...
- **Los cajeros que trabajarán en esta tienda tienen cuentas de WordPress** con un perfil que incluye la capacidad *Acceso a WCPOS*. Si aún no se ha configurado, consulte [Ajustes de acceso](/settings/wp-admin/access).
...
- **Usuarios autorizados** — lista de casillas de verificación de todos los usuarios de WordPress cuyo perfil tiene la capacidad *Acceso a WCPOS*. Seleccione los cajeros que deben poder iniciar sesión en esta tienda. **Dejar la lista vacía significa que todos los usuarios con capacidad para POS están autorizados** — útil para sitios con una sola tienda.
