...
:::info Función Pro
La pantalla de Clientes requiere [WCPOS Pro](/getting-started/pro-license). Los usuarios gratuitos pueden seleccionar clientes existentes para pedidos, pero no pueden ver la lista completa de clientes ni editar detalles del cliente.
:::
...
- Conteo de clientes con botón de sincronización (<Icon name="arrow-rotate-right" />). **Presionar largo** para opción de Borrar y Actualizar
