...
La búsqueda encuentra **todas las palabras** que escriba, en cualquier orden y en esos campos; por ejemplo, "jane paris" encuentra a Jane, cuya ciudad es París. La ordenación y el filtrado se ejecutan en el servidor e incluyen a todos sus clientes, no solo a los que ya están en el dispositivo.
