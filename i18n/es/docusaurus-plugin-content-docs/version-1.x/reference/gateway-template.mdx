...
- **[Factura por Email](/payment/gateways/email-invoice)** — Envía un correo electrónico de factura para que el cliente pueda pagar más tarde
- **[Pago Web](/payment/gateways/web-checkout)** — Redirige a la tienda web para el pago