...
## Visualizando los Datos JSON en el POS {#viewing-the-json-data-in-the-pos}
...
## ¿Por Qué No Funcionan Algunos Plugins en el POS? {#why-dont-some-plugins-work-in-the-pos}
