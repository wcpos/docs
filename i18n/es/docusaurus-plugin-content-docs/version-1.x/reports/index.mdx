...
- Ayuda a identificar horarios de ventas pico
...
Haga clic en el ícono de deslizadores (<Icon name="sliders" />) para personalizar la tabla de pedidos.
...
2. Anote el total de efectivo del informe
3. Conteo del efectivo físico en el cajón
...
2. Anote el total de la tarjeta del informe
