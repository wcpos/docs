...
- Si se utiliza un terminal con liquidación manual de lotes, **liquidar el lote ahora**, antes de salir. Las pasarelas integradas como Stripe Terminal liquidan automáticamente. Para la configuración de Square a través de Pago en línea, consultar [Pago en línea](/payment/gateways/web-checkout).

</StepCard>
  <StepCard number="6" title="Imprimir el informe">

En el panel de Resumen de la pantalla de Informes, hacer clic en **Imprimir**. Normalmente se utiliza el enrutamiento de impresión configurado (consultar [Enrutamiento de impresión](/hardware/printers#print-routing)) para enviar el informe a una impresora de recibos o de documentos, generando un registro en papel.
