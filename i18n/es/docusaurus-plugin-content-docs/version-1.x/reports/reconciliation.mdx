...
- Si se utiliza un terminal con liquidación manual de lotes, **liquidar el lote ahora**, antes de salir. Las pasarelas integradas como Stripe Terminal liquidan automáticamente. Para la configuración de Square a través de Web Checkout, consultar [Web Checkout](/payment/custom-gateways/web-checkout).
