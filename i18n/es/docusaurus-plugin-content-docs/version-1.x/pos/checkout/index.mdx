...
Cuando estés listo para completar una venta, haz clic en el botón **Pago** para abrir el modal de pago. Aquí es donde procesas el pago y completas el pedido.
...
- **Número de pedido** - El ID del pedido de WooCommerce
- **Monto a Pagar** - Monto total a pagar
- Botón **Configuraciones de Pago** - Solucionar problemas de visualización
- **Cajero** - Quien está procesando el pedido
- **Cliente** - El cliente para este pedido (enlace clickeable)
- Campo **Código de cupón** - Aplicar códigos de descuento
...
Consulta [Pago](/payment) para obtener detalles sobre la configuración de pasarelas.
...
## Configuraciones de Pago (Solución de Problemas)

El modal de pago utiliza un iframe/webview para mostrar la página de Pago de Pedido de WooCommerce. Esto aprovecha la infraestructura de pago existente de WooCommerce, lo que significa que cualquier pasarela de pago que funcione con WooCommerce debería funcionar en el POS.

Sin embargo, los scripts de temas y plugins a veces pueden interferir. Haz clic en **Configuraciones de Pago** para solucionarlo:

<div class="image-container">
  <Image
    alt="Configuraciones de Pago en el Modal de Pago"
    img="/img/checkout-settings.png"
    style={{ maxHeight: 600 }}
  />
  <p class="image-caption">Configuraciones de Pago en el Modal de Pago</p>
</div>
...
Desactiva selectivamente CSS que puede causar problemas de visualización:
...
Desactiva selectivamente JavaScript que puede interferir con las pasarelas de pago:
...
- [Recibos](/pos/checkout/receipts) - Después de pagar, imprime o envía por correo los recibos
