...
sidebar_position: 1
description: Completa ventas en el checkout de WCPOS, incluyendo procesamiento de pagos, pagos divididos y finalización de pedidos.
---
...
Cuando estés listo para completar una venta, haz clic en el botón **Checkout** para abrir el modal de checkout. Aquí es donde procesas el pago y completas el pedido.

{/* Screenshot: checkout-modal.png */}

## Resumen del Modal de Checkout {#checkout-modal-overview}

El modal de checkout muestra:

- **Número de pedido** - El ID de pedido de WooCommerce
- **Cantidad a Pagar** - Total a deber
- **Botón de Checkout Settings** - Solucionar problemas de visualización
...
- **Efectivo** - Con cantidad entregada y calculadora de cambio
- **Tarjeta** - Para terminales de tarjetas externos

### Pasarelas Adicionales <span class="badge badge--primary">Pro</span> {#additional-gateways-pro}
...
### Seleccionando un Método de Pago {#selecting-a-payment-method}

Haz clic en un método de pago para seleccionarlo. El formulario se actualiza para mostrar los campos relevantes:

**Efectivo:**

- **Cantidad Entregada** - Ingresa la cantidad que el cliente te da
...
## Códigos de Cupón <span class="badge badge--primary">Pro</span> {#coupon-codes}
...
## Procesando el Pago {#processing-payment}

1. Selecciona un método de pago
2. Para efectivo, ingresa la cantidad entregada
3. Haz clic en **Procesar Pago**
4. El pedido se completa y se muestra el [recibo](/pos/checkout/receipts)

## Checkout Settings (Solución de Problemas) {#checkout-settings-troubleshooting}

El modal de checkout utiliza un iframe/webview para mostrar la página de pago del pedido de WooCommerce. Esto aprovecha la infraestructura de pago existente de WooCommerce, lo que significa que cualquier pasarela de pago que funcione con WooCommerce debería funcionar en el POS.
...
Haz clic en **Cancelar** para cerrar el modal de checkout sin completar el pedido. El pedido permanece como un carrito abierto.

## Documentación Relacionada {#related-documentation}

<LinkCards>
  <LinkCard to="/pos/checkout/receipts" title="Recibos" description="Después del checkout, imprime o envía recibos por correo" />
