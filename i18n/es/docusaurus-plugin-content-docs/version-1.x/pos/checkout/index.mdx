...
- **Checkout Settings** botón - Solucionar problemas de visualización
...
- Botones de **Cancelar / Process Payment**
...
Consulta [Payment](/payment) para más detalles sobre la configuración de pasarelas.
