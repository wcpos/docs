...
WCPOS almacena las órdenes en la base de datos local del dispositivo. Esto proporciona:
...
- Puedes completar una orden con un método de pago compatible con el modo sin conexión; las pasarelas que dependen del servidor siguen sin estar disponibles hasta que sus servicios sean accesibles
