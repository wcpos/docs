...
- Desliza hacia la izquierda/derecha para ver más carritos
...
Haz clic en cualquier orden en el carrusel para cambiar a ella. El Panel de Carrito se actualiza para mostrar el contenido de la orden seleccionada.
...
- No puedes completar/pagar órdenes hasta que se restablezca la conectividad
