---
title: "API02005 : Permissions Insuffisantes"
sidebar_label: API02005
---

# API02005 : Permissions Insuffisantes {#api02005-insufficient-permissions}
...
### 1. Réviser les Capacités Nécessaires {#1-review-required-capabilities}
...
### 2. Mettre à Niveau le Rôle de l'Utilisateur {#2-upgrade-user-role}
...
### 3. Ajouter des Capacités Spécifiques {#3-add-specific-capabilities}
...
### 4. Vérifier les Conflits de Plugin {#4-check-plugin-conflicts}
