...
Réessayez l’action une fois de plus. Si cela se reproduit, déconnectez-vous puis reconnectez-vous, et exportez les diagnostics avant de contacter l’assistance.
