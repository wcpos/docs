...
# API04001 : Format de Réponse Invalide {#api04001-invalid-response-format}
...
### 1. Vérifiez Votre Site {#1-check-your-site}
...
### 2. Vérifiez les Erreurs PHP {#2-check-for-php-errors}
...
### 3. Testez l'API REST Directement {#3-test-the-rest-api-directly}
...
### 4. Désactivez le Cache Temporairement {#4-disable-caching-temporarily}
