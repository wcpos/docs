...
La demande envoyée au serveur n'était pas dans le format attendu. Le serveur n'a pas pu comprendre ce que le point de vente demandait car la structure de la demande était incorrecte.

## Causes Courantes

- **Données corrompues** — Les données ont été corrompues avant l'envoi
- **Erreur de logiciel** — Un problème dans l'application POS
...
Parfois, il s'agit d'un problème temporaire :
