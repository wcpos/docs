...
# API04006 : Ressource Non Trouvée {#api04006-resource-not-found}
...
### 1. Vérifiez si la Ressource Existe {#1-check-if-the-resource-exists}
...
### 2. Rafraîchissez les Données Locales {#2-refresh-local-data}
...
### 3. Vérifiez les Permaliens WordPress {#3-check-wordpress-permalinks}
...
### 4. Vérifiez les Routes API {#4-verify-api-routes}
