...
1. Vendez normalement — le produit n’est pas affecté et l’image est rechargée en arrière-plan.
2. Si l’image d’un produit ne se charge jamais, ouvrez le produit dans WP Admin et réenregistrez son image ; le fichier a peut-être été supprimé de la médiathèque.
3. Si de nombreuses images échouent en même temps, la cause est l’hébergement des médias du site ou son CDN — vérifiez si les images se chargent sur le site de la boutique lui-même.
