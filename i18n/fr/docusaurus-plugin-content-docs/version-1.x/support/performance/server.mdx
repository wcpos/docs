...
La performance du serveur impacte directement la vitesse et la réactivité de votre application WCPOS. Ce guide vous aide à surveiller, diagnostiquer et optimiser les performances du serveur en utilisant les métriques intégrées et les techniques de dépannage.
...
**Solutions :**
- **Upgrade du CPU** - Plus de cœurs traitent mieux les requêtes simultanées
...
**Solutions :**
- **Activer WooCommerce HPOS** - Le plus grand amélioration des performances de la base de données
...
- Plugins d'analyse/tracking en temps réel
...
:::tip Plus grande amélioration de performance
...
**Activer HPOS :**
- La seule amélioration de performance la plus impactante pour WooCommerce
