...
- **La finalisation de la vente peut fonctionner hors connexion** avec un moyen de paiement compatible hors connexion. La commande est mise en file d'attente localement ; le serveur revalide le coupon et met à jour son compteur d'utilisation lorsque la commande parvient à WooCommerce.
