...
sidebar_label: Finalisation de la commande
sidebar_position: 1
---

import Image from "@theme/IdealImage";

Lorsque vous êtes prêt à finaliser une vente, cliquez sur le bouton **Finalisation de la commande** pour ouvrir le modal de finalisation de la commande. C'est ici que vous traitez le paiement et complétez la commande.

{/* Capture d'écran: checkout-modal.png */}

## Aperçu du Modal de Finalisation

Le modal de finalisation affiche :

- **Numéro de commande** - L'ID de commande WooCommerce
- **Montant à payer** - Montant total dû
- **Bouton Paramètres de Finalisation** - Résoudre les problèmes d'affichage
...
Consultez [Méthodes de paiement](/payment) pour des détails sur la configuration des passerelles.
...
- **Monnaie** - Calcul automatique de la monnaie à rendre
...
## Paramètres de Finalisation (Dépannage)

Le modal de finalisation utilise un iframe/webview pour afficher la page de paiement de la commande WooCommerce. Cela tire parti de l'infrastructure de paiement existante de WooCommerce, signifiant que toute passerelle de paiement qui fonctionne avec WooCommerce devrait fonctionner dans le POS.

Cependant, les scripts de thème et de plugin peuvent parfois interférer. Cliquez sur **Paramètres de Finalisation** pour dépanner :

<div class="image-container">
  <Image
    alt="Paramètres de Finalisation dans le Modal de Finalisation"
    img="/img/checkout-settings.png"
    style={{ maxHeight: 600 }}
  />
  <p class="image-caption">Paramètres de Finalisation dans le Modal de Finalisation</p>
</div>
...
Cliquez sur **Annuler** pour fermer le modal de finalisation sans finaliser la commande. La commande reste en tant que panier ouvert.
