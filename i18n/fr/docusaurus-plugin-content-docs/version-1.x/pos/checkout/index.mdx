...
Lorsque vous êtes prêt à finaliser une vente, cliquez sur le bouton **Paiement** pour ouvrir le modal de paiement. C'est ici que vous traitez le paiement et complétez la commande.

{/* Capture d'écran: checkout-modal.png */}

## Aperçu du modal de paiement

Le modal de paiement affiche :
...
Le modal de paiement utilise un iframe/webview pour afficher la page de paiement de la commande WooCommerce. Cela tire parti de l'infrastructure de paiement existante de WooCommerce, signifiant que toute passerelle de paiement qui fonctionne avec WooCommerce devrait fonctionner dans le POS.

Cependant, les scripts de thème et de plugin peuvent parfois interférer. Cliquez sur **Paramètres de Paiement** pour dépanner :

<div class="image-container">
  <Image
    alt="Paramètres de Paiement dans le Modal de Paiement"
    img="/img/checkout-settings.png"
    style={{ maxHeight: 600 }}
  />
  <p class="image-caption">Paramètres de Paiement dans le Modal de Paiement</p>
</div>
...
Cliquez sur **Annuler** pour fermer le modal de paiement sans finaliser la commande. La commande reste en tant que panier ouvert.
