...
sidebar_position: 3
description: "Travaillez avec plusieurs commandes simultanément dans WCPOS, y compris les pauses de commandes, le changement entre les transactions et la récupération des interruptions."
---
...
WCPOS stocke les commandes dans la base de données locale de l'appareil. Cela fournit :
...
- Vous pouvez finaliser une commande avec un moyen de paiement compatible hors connexion ; les passerelles dépendant du serveur restent indisponibles tant que leurs services ne sont pas joignables
