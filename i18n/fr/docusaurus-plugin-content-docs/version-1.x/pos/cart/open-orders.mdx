...
WCPOS vous permet de travailler avec plusieurs commandes simultanément. C'est utile pour gérer les attentes des clients, passer d'une transaction à l'autre et récupérer après des interruptions.
...
- Cliquez sur n'importe quel panier pour basculer vers celui-ci
...
Cliquez sur n'importe quelle commande dans le carrousel pour basculer vers celle-ci. Le panneau du panier se met à jour pour montrer le contenu de la commande sélectionnée.

**Cas d'utilisation :**

- Le client s'éloigne pour prendre un autre article
...
Lorsque vous sauvegardez sur le serveur ou lorsque vous passez à la caisse :
