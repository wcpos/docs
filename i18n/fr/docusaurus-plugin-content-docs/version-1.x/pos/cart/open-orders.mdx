...
## Carrousel des Commandes Ouvertes {#open-orders-carousel}
...
## Création d'une Nouvelle Commande {#creating-a-new-order}
...
## Changement entre les Commandes {#switching-between-orders}
...
## Sauvegarde des Commandes sur le Serveur {#saving-orders-to-server}
...
### Sauvegardé sur le Serveur {#saved-to-server}
...
## Récupération des Commandes Sauvegardées {#recovering-saved-orders}
...
## Persistance des Commandes {#order-persistence}
...
### Synchronisation avec le Serveur {#sync-with-server}
...
## Annulation des Commandes {#voiding-orders}
...
### Gardez les Commandes Organisées {#keep-orders-organized}
...
### Passation de Shift {#shift-handoffs}
...
### Considérations Hors Ligne {#offline-considerations}
