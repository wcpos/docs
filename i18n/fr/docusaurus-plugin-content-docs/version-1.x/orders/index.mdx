...
- **Filtre de statut** - Filtre par statut de commande (Complété, En cours, etc.)
...
- **Methode de paiement** - Espèces, Carte, etc.
- **Total** - Montant total de la commande
- **Actions** - Menu à trois points

### Pied de page

- Nombre de commandes avec bouton de synchronisation (<Icon name="arrow-rotate-right" />). **Appuyez longuement** pour l'option Effacer et Actualiser
