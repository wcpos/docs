...
L'écran des Commandes fournit un accès à votre historique de commandes directement dans le POS. Consultez les commandes passées, réimprimez des reçus et gérez les détails des commandes sans passer à l'administration WooCommerce.
...
- **Indicateur de note** - Bullette de discours lorsque la commande a des notes
