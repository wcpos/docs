...
| -------------- | ------------------------------------------------------ | ------------------------------------ |
| **Plugin**     | Modèle de reçu principal inclus avec WCPOS   | Toujours disponible                  |
| **Plugin Pro** | Modèle amélioré de WCPOS Pro                 | Disponible avec licence active       |
...
5. Consultez la documentation WCPOS pour des personnalisations avancées
...
WCPOS fournit divers hooks et filtres pour la personnalisation des modèles. Consultez la documentation des développeurs pour les options disponibles.
