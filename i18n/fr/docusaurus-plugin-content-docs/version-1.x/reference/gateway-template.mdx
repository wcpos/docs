...
- **[Facture par Email](/payment/gateways/email-invoice)** — Envoie un email de facture pour que le client puisse payer plus tard
- **[Paiement Web](/payment/gateways/web-checkout)** — Redirige vers la boutique en ligne pour paiement