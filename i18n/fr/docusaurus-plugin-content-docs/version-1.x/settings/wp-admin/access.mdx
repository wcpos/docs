...
sidebar_label: Accès
description: Configurez les rôles et les capacités des utilisateurs pour l'accès à WCPOS, y compris les autorisations Administrateur, Responsable de Boutique et Caissier.
---
...
| Responsable de Boutique | WooCommerce | Ce rôle est destiné aux utilisateurs qui ont besoin d'accéder au POS et de gérer les paramètres du POS. Les Responsables de Boutique peuvent ne pas avoir la permission d'installer des plugins ou d'effectuer d'autres tâches administratives.                                                                                                    |
