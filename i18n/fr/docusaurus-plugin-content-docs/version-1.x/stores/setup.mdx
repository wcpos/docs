...
- **Les caissiers qui travailleront dans ce point de vente disposent de comptes WordPress** avec un rôle incluant la capacité *Accès à WCPOS*. Si vous ne l’avez pas encore configuré, consultez les [Paramètres d’accès](/settings/wp-admin/access).
