...
The following information is intended to assist users until WCPOS Pro officially supports multi-inventory.
:::

Multi-inventory stores is one of the most requested features for WCPOS Pro.
...
By creating a site for each store, you can then install WooCommerce and WCPOS on each site, keeping each store inventory completely separate.
