...
- **[ईमेल चालान](/payment/gateways/email-invoice)** — एक चालान ईमेल भेजता है ताकि ग्राहक बाद में भुगतान कर सके
- **[वेब चेकआउट](/payment/gateways/web-checkout)** — भुगतान के लिए वेब स्टोर पर पुनर्निर्देशित करता है