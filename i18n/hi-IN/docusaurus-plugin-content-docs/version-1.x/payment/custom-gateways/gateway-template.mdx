...
3. **पार्श्व संकेतों का पालन करें**:
...
3. **दस्तावेज़ीकरण**: स्थापना निर्देशों के साथ README शामिल करें
...
- [WooCommerce POS दस्तावेज़ीकरण](https://docs.wcpos.com/)
...
- **[Stripe Terminal](./stripe-terminal)**: हार्डवेयर एकीकरण उदाहरण
- **[SumUp Terminal](./sumup-terminal)**: API-आधारित टर्मिनल एकीकरण
- **[Email Invoice](./email-invoice)**: सरल ईमेल-आधारित गेटवे
- **[Web Checkout](./web-checkout)**: वेब एकीकरण गेटवे