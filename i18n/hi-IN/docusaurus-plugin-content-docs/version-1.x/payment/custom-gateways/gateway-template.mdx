...
<FeatureGrid>
  ...
  <FeatureCard icon="puzzle-piece" title="विस्तार योग्य">
...
### विकल्प 1: स्वचालित टेम्पलेट निर्माण {#option-1-automated-template-generation}
...
## अनुकूलन गाइड {#customisation-guide}
...
- **[Stripe टर्मिनल](./stripe-terminal)**: हार्डवेयर एकीकरण उदाहरण
