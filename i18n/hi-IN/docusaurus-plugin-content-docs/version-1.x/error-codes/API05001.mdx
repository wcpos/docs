...
# API05001: WooCommerce API अक्षम {#api05001-woocommerce-api-disabled}
...
### 1. WooCommerce REST API सक्षम करें {#1-enable-woocommerce-rest-api}
...
### 2. WordPress REST API जाँचें {#2-check-wordpress-rest-api}
...
### 3. सुरक्षा प्लगइन जाँचें {#3-check-security-plugins}
...
### 4. .htaccess जाँचें {#4-check-htaccess}
...
### 5. Permalinks फ्लश करें {#5-flush-permalinks}
