...
# API05004: वर्डप्रेस API अक्षम {#api05004-wordpress-api-disabled}
...
### 1. REST API का परीक्षण करें {#1-test-the-rest-api}
...
### 2. सुरक्षा प्लगइनों की जाँच करें {#2-check-security-plugins}
...
### 3. कस्टम कोड की जाँच करें {#3-check-for-custom-code}
...
### 4. .htaccess की जाँच करें {#4-check-htaccess}
...
### 5. होस्टिंग प्रदाता से संपर्क करें {#5-contact-hosting-provider}
...
## REST API क्यों महत्वपूर्ण है {#why-rest-api-matters}
