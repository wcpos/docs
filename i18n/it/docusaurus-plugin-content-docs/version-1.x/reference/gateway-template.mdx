...
- **[Fattura via Email](/payment/gateways/email-invoice)** — Invia un'email di fattura in modo che il cliente possa pagare più tardi
- **[Checkout Web](/payment/gateways/web-checkout)** — Reindirizza al negozio online per il pagamento