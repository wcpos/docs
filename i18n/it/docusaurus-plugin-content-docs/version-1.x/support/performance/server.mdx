...
sidebar_position: 2
description: Ottimizza le prestazioni del server WordPress per WCPOS, inclusi HPOS, caching, ottimizzazione del database e raccomandazioni di hosting.
---
...
Le medie del carico del server non sempre corrispondono direttamente alle prestazioni. Un server con valori di carico elevati (15+) può comunque essere molto reattivo se ha risorse sufficienti e è ben ottimizzato. **Concentrati sui tempi di esecuzione piuttosto che sui valori di carico da soli.**
:::
...
### Passo 1: Monitorare i Log {#step-1-monitor-the-logs}
...
<LinkCards>
  <LinkCard to="/support/logs" title="Log" description="Come accedere e interpretare le metriche del server" />
