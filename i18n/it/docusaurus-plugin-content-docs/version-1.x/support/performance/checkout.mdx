...
Il checkout di WCPOS apre un `modal` con un iframe/webview che carica una versione ridotta del template di pagamento degli ordini di WooCommerce. Questa è essenzialmente la stessa pagina della [Pagina di Pagamento per i Clienti](https://woocommerce.com/document/managing-orders/paying-for-orders/#customer-payment-page-link) che i clienti vedono quando pagano gli ordini online.
