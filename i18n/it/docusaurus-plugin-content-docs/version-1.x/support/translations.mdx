...
- **Le lingue da destra a sinistra (RTL)** — arabo, ebraico, persiano, urdu — hanno anche bisogno che i template delle ricevute siano contrassegnati come RTL. WCPOS include template RTL delle ricevute integrati; vedi [Personalizza la tua ricevuta](/receipts/customise) per la galleria.
