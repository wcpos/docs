...
- **Mantieni esatti i nomi di brand e prodotti.** `WCPOS`, `WCPOS Pro`, `WooCommerce`, `WordPress`, `Stripe`, `Stripe Terminal` e `SumUp` restano invariati. Usa **WCPOS** nei testi rivolti ai clienti; i vecchi nomi di prodotto vanno usati solo negli identificativi tecnici come slug e URL.
