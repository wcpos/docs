...
<Accordion>
  <AccordionItem question="Evitare che la casella di posta venga sommersa nelle giornate intense">
...
Per il monitoraggio dei ricavi, la schermata [Report](/reports) è comunque uno strumento migliore rispetto al conteggio delle email di nuovo ordine.
  ...
  <AccordionItem question="Inviare le notifiche solo al cassiere in servizio, non all'amministratore">
...
Questa soluzione funziona bene per i negozi con più cassieri in cui il titolare non vuole essere coinvolto in ogni transazione.
  ...
  <AccordionItem question="Disabilitare le email ai clienti per le vendite in negozio">
...
Le email destinate ai clienti per gli ordini online restano invariate, poiché passano attraverso WooCommerce standard (non il percorso POS).
  ...
  <AccordionItem question="Mantenere attive le email ai clienti, ma non quella 'In lavorazione'">
...
Se gli ordini POS vengono completati istantaneamente (contanti + carta presente), il cliente riceve un'email *In lavorazione* *e* un'email *Completato* nello stesso secondo. Deselezionare **Ordine in lavorazione** nell'elenco Email cliente per eliminare quella ridondante.
  ...
  <AccordionItem question="Ho effettuato l'aggiornamento da una versione precedente alla v1.8.9 e il mio vecchio interruttore singolo 'Abilita email' è scomparso">
