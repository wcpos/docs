...
# API05001: API WooCommerce Disabilitata {#api05001-woocommerce-api-disabled}
...
### 1. Abilita l'API REST di WooCommerce {#1-enable-woocommerce-rest-api}
...
### 2. Controlla l'API REST di WordPress {#2-check-wordpress-rest-api}
...
### 4. Controlla .htaccess {#4-check-htaccess}
...
### 5. Cancella i Permalink {#5-flush-permalinks}
