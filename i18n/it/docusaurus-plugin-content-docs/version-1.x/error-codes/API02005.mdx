...
| Codice Server | Fonte |
|-------------|--------|
| `rest_forbidden` | API REST di WordPress |
| `rest_cannot_create` | API REST di WordPress |
| `rest_cannot_edit` | API REST di WordPress |
| `rest_cannot_delete` | API REST di WordPress |
| `woocommerce_rest_cannot_create` | API REST di WooCommerce |
| `woocommerce_rest_cannot_edit` | API REST di WooCommerce |
| `woocommerce_rest_cannot_delete` | API REST di WooCommerce |
