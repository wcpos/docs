...
WCPOS memorizza gli ordini nel database locale sul dispositivo. Questo fornisce:
...
- Puoi completare un ordine con un metodo di pagamento utilizzabile offline; i gateway che dipendono dal server restano non disponibili finché i loro servizi non sono raggiungibili
