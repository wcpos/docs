...
sidebar_position: 3
description: "Lavora con più ordini contemporaneamente in WCPOS, inclusi ordini in attesa, cambio tra transazioni e recupero da interruzioni."
---

WCPOS ti consente di lavorare con più ordini contemporaneamente. Questo è utile per gestire le attese dei clienti, passare da una transazione all'altra e recuperare da interruzioni.
...
1. Aprendo il **schermata Ordini** (funzionalità Pro)
