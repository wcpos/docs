...
| -------------- | -------------------------------------------------- | ------------------------------------ |
| **Plugin**     | Modello di ricevuta core incluso in WCPOS | Sempre disponibile                    |
...
WCPOS fornisce vari hooks e filtri per la personalizzazione dei modelli. Consulta la documentazione per sviluppatori per le opzioni disponibili.
