...
当您准备完成销售时，点击 **结账** 按钮以打开结账模态。这是您处理支付和完成订单的地方。
...
:::info 专业功能
额外的付款网关需要 [WCPOS Pro](/getting-started/pro-license).
:::

通过专业版，您可以启用：

- **Stripe 终端** - 与 Stripe 卡读卡器的直接集成
- **SumUp 终端** - 与 SumUp 卡读卡器的集成
- **自定义网关** - 创建您自己的付款集成
...
结账模态使用 iframe/webview 显示 WooCommerce 订单支付页面。这利用了 WooCommerce 现有的支付基础设施，这意味着任何可与 WooCommerce 一起使用的支付网关都应该可以在 POS 中使用。
...
:::warning 核心选项
这是核心选项，仅应在测试或开发者知道他们在做什么的情况下使用。禁用所有 wp_head 脚本将移除即使是 WooCommerce 的脚本，这些脚本需要扩展/收缩支付网关，可能会破坏支付功能。
:::
...
- [付款方式](/payment) - 配置付款网关
- [自定义网关](/payment/custom-gateways) - 创建自定义付款集成