...
# API04005: 尝试恢复 JSON {#api04005-json-recovery-attempted}
...
### 1. 禁用 PHP 显示错误 {#1-disable-php-display-errors}
...
### 2. 启用错误日志记录 {#2-enable-error-logging-instead}
...
### 3. 检查插件调试模式 {#3-check-for-plugin-debug-mode}
...
### 4. 检查最近的变更 {#4-review-recent-changes}
