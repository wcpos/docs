...
# API02004: 用户未授权 {#api02004-user-not-authorized}
...
### 2. 启用 POS 访问 {#2-enable-pos-access}
...
### 3. 请求额外权限 {#3-request-additional-permissions}
...
### 4. 检查商店分配 {#4-check-store-assignment}
