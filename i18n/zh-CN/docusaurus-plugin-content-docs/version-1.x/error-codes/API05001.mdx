...
# API05001: WooCommerce API 被禁用 {#api05001-woocommerce-api-disabled}
...
### 1. 启用 WooCommerce REST API {#1-enable-woocommerce-rest-api}
...
### 2. 检查 WordPress REST API {#2-check-wordpress-rest-api}
