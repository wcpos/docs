...
# API04001: 无效的响应格式 {#api04001-invalid-response-format}
...
### 2. 检查 PHP 错误 {#2-check-for-php-errors}
...
### 3. 直接测试 REST API {#3-test-the-rest-api-directly}
...
### 4. 暂时禁用缓存 {#4-disable-caching-temporarily}
