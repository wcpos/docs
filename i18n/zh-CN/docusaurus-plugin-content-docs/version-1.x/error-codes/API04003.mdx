...
# API04003: JSON 响应格式错误 {#api04003-malformed-json-response}
...
### 1. 检查 PHP 通知 {#1-check-for-php-notices}
...
### 2. 检查 BOM 字符 {#2-check-for-bom-characters}
...
### 3. 验证完整响应 {#3-verify-complete-response}
...
### 4. 直接测试 API {#4-test-api-directly}
...
### 5. 检查字符编码 {#5-check-character-encoding}
