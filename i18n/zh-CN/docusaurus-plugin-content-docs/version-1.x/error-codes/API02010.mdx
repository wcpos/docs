...
# API02010: 需要认证 {#api02010-auth-required}
...
### 2. 检查会话状态 {#2-check-session-status}
...
### 3. 验证服务器配置 {#3-verify-server-configuration}
...
### 4. 检查浏览器/应用问题 {#4-check-for-browserapp-issues}
...
## 什么需要认证？ {#what-requires-authentication}
