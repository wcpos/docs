...
| **简易热敏收据（58mm）** | Thermal | 简洁的 58mm 热敏打印布局 |
...
1. **最简单** — 在 **WP Admin → POS → 设置 → 店铺 → 店铺详情 → 收据页脚/个人备注** 中设置一次，即可应用于所有收据。内置模板会自动使用该设置；如果未设置页脚，则会回退到友好的默认内容，例如 *"Thank you for your purchase!"*。
