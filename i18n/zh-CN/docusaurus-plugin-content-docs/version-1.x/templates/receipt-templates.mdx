...
| 来源          | 描述                                             | 状态                                 |
| -------------- | ------------------------------------------------ | ------------------------------------ |
| **插件**      | WCPOS 附带的核心收据模板            | 始终可用                             |
| **专业插件**  | 来自 WCPOS Pro 的增强模板             | 在许可有效时可用                     |
...
### 方法 2：从头开始创建 {#method-2-create-from-scratch}
...
WCPOS 提供了多种钩子和过滤器以允许模板自定义。请查阅开发者文档以了解可用选项。
