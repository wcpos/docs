...
| **Scan sound** | Play an optional sound on each scan so cashiers get instant confirmation without looking at the screen. Off by default; choose from several sound themes when enabled |
