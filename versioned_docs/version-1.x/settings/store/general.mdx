...
sidebar_position: 2
description: Configure WCPOS store settings including currency display, number formatting, and default order status.
---
...
### Thousands Group Style {#thousands-group-style}
...
### Default Customer is Cashier {#default-customer-is-cashier}
