...
Install the **Narrow Receipt** template from the gallery — it's a monospace, 72mm-wide layout that prints cleanly on browser print, HTML-capable thermal printers (Sunmi/Imin WebView devices), and standard paper. Not for raw ESC/POS thermal printers — use the **Thermal Simple** XML templates for those.
:::
