...
On the **mobile apps**, the Add Printer form lists nearby printers for **Bluetooth** and **USB** connections — tap **Scan for printers** or **Refresh** and pick yours from the list. Its name and vendor fill in automatically.
