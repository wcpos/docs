...
| -------------- | --------------------------------------------------- | ------------------------------------ |
| **Plugin**     | Core receipt template included with WCPOS     | Always available                     |
| **Pro Plugin** | Enhanced template from WCPOS Pro              | Available with active license        |
...
<Accordion>
  <AccordionItem question="Template not showing changes">
  ...
  <AccordionItem question="Syntax errors">
  ...
  <AccordionItem question="Styling issues">
  ...
  <AccordionItem question="Template not available">
...
5. Consult the WCPOS documentation for advanced customisation
...
WCPOS provides various hooks and filters for template customisation. Consult the developer documentation for available options.
