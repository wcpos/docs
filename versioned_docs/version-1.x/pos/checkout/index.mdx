...
### Additional Gateways <span class="badge badge--primary">Pro</span>
...
:::info Pro Feature
Coupon support requires [WCPOS Pro](/getting-started/pro-license).
:::

### Supported Discount Types

WCPOS supports the following WooCommerce coupon types:
...
1. Click the **Add Coupon** button in the cart area
2. Enter the coupon code — the POS looks it up from locally synced coupons
3. The discount is validated instantly and appears in the order summary

Coupon discounts auto-recalculate when cart contents change.

### Validation

The POS validates coupons against WooCommerce rules:

- Coupon expiry date
- Usage limits (per coupon and per user)
- Minimum and maximum spend requirements
- Individual use restrictions (cannot be combined with other coupons)
- Email restrictions
...
Coupons must be configured in WooCommerce (`WP Admin > Marketing > Coupons`). Once created, Pro syncs them to the POS automatically.
