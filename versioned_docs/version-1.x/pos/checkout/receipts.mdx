...
See [Receipt Templates](/templates/receipt-templates) for details on customising:
...
<LinkCards>
  <LinkCard to="/templates/receipt-templates" title="Receipt Templates" description="Customise receipt appearance" />
