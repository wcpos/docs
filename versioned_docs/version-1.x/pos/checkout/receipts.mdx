...
sidebar_position: 2
description: Print and email receipts in WCPOS, including printer setup and receipt customisation options.
---
...
## Automatic Receipt Options {#automatic-receipt-options}
...
## Customising Receipts {#customising-receipts}

Receipt appearance is controlled by templates in WordPress:

`WP Admin > POS > Templates`

See [Receipt Templates](/templates) for details on customising:
...
<LinkCards>
  <LinkCard to="/templates" title="Receipt Templates" description="Customise receipt appearance" />
  <LinkCard to="/templates/cloud-printing" title="Cloud Printing" description="Print to Star, Epson, and PrintNode printers" />
  <LinkCard to="/pos/cart#display-settings" title="Cart Settings" description="Auto-show and auto-print options" />
  <LinkCard to="/orders" title="Orders" description="Reprint past receipts (Pro)" />
</LinkCards>
