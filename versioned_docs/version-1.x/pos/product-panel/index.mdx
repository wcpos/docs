...
Click the **sliders icon** (⚙️) next to the search bar to open Display Settings. This allows you to customize which columns and information are shown in the product list.
...
Click the sliders icon to customize the Product Panel display.
...
Variable products (e.g., a t-shirt with size and color options) show a green **→** arrow. Click to:
