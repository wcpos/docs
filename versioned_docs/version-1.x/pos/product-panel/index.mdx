...
Click the **sliders icon** (⚙️) next to the search bar to open Display Settings. This allows you to customise which columns and information are shown in the product list.
