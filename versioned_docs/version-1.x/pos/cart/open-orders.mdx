...
sidebar_position: 3
description: "Work with multiple orders simultaneously in WCPOS including parking orders, switching between transactions, and recovering from interruptions."
---
...
## Open Orders Carousel {#open-orders-carousel}
...
## Switching Between Orders {#switching-between-orders}
...
## Saving Orders to Server {#saving-orders-to-server}
...
### Saved to Server {#saved-to-server}
...
## Recovering Saved Orders {#recovering-saved-orders}
...
WCPOS stores orders in the local database on the device. This provides:
...
### Keep Orders Organized {#keep-orders-organized}
...
- You can complete an order with an offline-capable payment method; server-dependent gateways remain unavailable until their services are reachable
