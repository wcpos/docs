...
If you need to track discount usage in WooCommerce reports or enforce rules like usage limits, use [Coupons](/coupons). For one-off price adjustments, the discounts on this page are simpler.
