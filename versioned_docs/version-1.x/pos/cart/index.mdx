...
- [Line Items](/pos/cart/line-items) - Editing cart line items
- [Open Orders](/pos/cart/open-orders) - Managing multiple carts
- [Order Actions](/pos/cart/order-actions) - Notes, metadata, and saving
- [Checkout](/pos/checkout) - Processing payment
