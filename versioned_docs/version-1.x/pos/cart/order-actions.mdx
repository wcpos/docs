...
sidebar_position: 4
description: Access order management features in WCPOS including order notes, meta data, fees, shipping, and discounts.
---
...
### What is Meta Data in WooCommerce? {#what-is-meta-data-in-woocommerce}
...
See [Open Orders](/pos/cart/open-orders) for more details on managing saved orders.
...
- Opens the [checkout screen](/pos/checkout) to complete the payment.
