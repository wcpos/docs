...
<RequirementsList>
  ...
  <RequirementItem label="WooCommerce">7.6 or newer. On older WooCommerce, WCPOS does not ask WooCommerce Tax for rates and POS orders use whatever rows the table already holds</RequirementItem>
