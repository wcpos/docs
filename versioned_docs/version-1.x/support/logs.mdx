...
Aggregate performance lives in **Store health → Performance**: requests, data transferred, and typical response time over the last 24 hours, plus an hourly uptime strip. If response times look high, see [Server Performance](/support/performance/server).
