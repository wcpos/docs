...
## The four places that hold translations {#the-four-places-that-hold-translations}
...
## WordPress plugin strings (the easiest place to start) {#wordpress-plugin-strings-the-easiest-place-to-start}
...
## POS app translations (the React UI) {#pos-app-translations-the-react-ui}
...
## WP Admin React screens {#wp-admin-react-screens}
...
## Documentation (these pages) {#documentation-these-pages}
...
## Locale codes WCPOS uses {#locale-codes-wcpos-uses}
