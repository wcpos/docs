...
Plugin conflicts are one of the most common causes of issues with WCPOS. When other WordPress plugins interfere with WooCommerce or WCPOS functionality, you may experience crashes, performance problems, or unexpected behavior.
...
3. **Performance plugins** - Caching, optimization
...
- [Critical Error](/support/troubleshooting/critical-error) - How to find fatal error logs
- [Logs](/support/logs) - Understanding WCPOS logs and metrics
- [Server Performance](/support/performance/server) - Diagnosing performance issues
- [Checkout Performance](/support/performance/checkout) - Optimizing checkout speed