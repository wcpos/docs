...
For detailed analytics across any date range, use **WP Admin > Analytics**. The POS Reports screen is optimized for quick end-of-day summaries and daily reconciliation.
:::
...
Click the display settings icon to customize columns.
...
Click the sliders icon (⚙️) to customize the orders table.
...
- [Orders](/orders) - Detailed order lookup
- [Checkout](/pos/checkout) - Payment processing
