...
An effective way to initiate the batch downloading of products is by using the product search function. Each time you conduct a product search, the POS system fetches and stores another batch of around 50 products. This strategy not only helps you gradually download new products, but also enhances the speed and efficiency of the search function as more products are stored locally.
