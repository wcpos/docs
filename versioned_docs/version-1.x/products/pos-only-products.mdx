...
- [WP Admin General Settings](/settings/wp-admin/general) - Enable the feature
- [Product Panel](/pos/product-panel) - The POS product browsing interface
- [Product Synchronisation](/products/sync) - How products sync between WooCommerce and POS
