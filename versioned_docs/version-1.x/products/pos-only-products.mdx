...
## Setting Product Visibility {#setting-product-visibility}
...
<div className="image-container">
  <Image
    ...
    style={{ maxHeight: 400 }}
  />
  <p className="image-caption">POS Visibility setting in the Product data panel</p>
</div>
...
<div className="image-container">
  <Image
    ...
    style={{ maxHeight: 500 }}
  />
  <p className="image-caption">Bulk editing POS visibility from the Products list</p>
</div>
...
<div className="image-container">
  <Image
    ...
    style={{ maxHeight: 300 }}
  />
  <p className="image-caption">Each variation has its own POS Visibility setting</p>
</div>

## How It Affects the POS {#how-it-affects-the-pos}
...
<Accordion>
  <AccordionItem question="Products still appearing after setting to Online Only">
  ...
  <AccordionItem question="Setting not showing on products">
