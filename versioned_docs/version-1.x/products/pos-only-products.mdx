...
For variable products, the visibility setting applies to the parent product and all its variations. You cannot set different visibility options for individual variations.
