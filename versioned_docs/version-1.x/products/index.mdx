...
<ComingSoon>Stock control to prevent overselling is in progress — it will block adding out-of-stock items to the cart and validate stock at checkout, respecting your WooCommerce backorder settings.</ComingSoon>
