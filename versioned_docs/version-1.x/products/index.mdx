...
The Products screen is a dedicated inventory management interface. Unlike the [POS Product Panel](/pos/product-panel) (which is for selling), this screen is designed for managing your product catalog.
...
- **Display settings** (⚙️) - Configure visible columns
...
- Attribute options (Color, Size, etc.)
...
Click the sliders icon (⚙️) to customize the Products screen.
