...
3. If the store's tax rates have not changed, the POS may be holding a stale copy. Refresh it from **Store health → Database → Tax rates → Clear & re-download** — this affects only that collection and does not log anyone out. See [Store health](/support/store-health#clear-and-redownload).
