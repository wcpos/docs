...
3. If the store's tax rates have not changed, the POS may be holding a stale copy. Open **Store health** and resync tax rates.
4. If the code returns after a resync, export debug info and contact support with the order number.
