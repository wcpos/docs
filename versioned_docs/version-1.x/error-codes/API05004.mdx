...
### 1. Test the REST API {#1-test-the-rest-api}
...
### 2. Check Security Plugins {#2-check-security-plugins}
...
### 3. Check for Custom Code {#3-check-for-custom-code}
...
### 5. Contact Hosting Provider {#5-contact-hosting-provider}
...
## Why REST API Matters {#why-rest-api-matters}
