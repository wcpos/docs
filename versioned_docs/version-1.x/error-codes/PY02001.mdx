...
### 1. Retry the Transaction {#1-retry-the-transaction}
...
### 2. Check Gateway Status {#2-check-gateway-status}
...
### 3. Verify Gateway Configuration {#3-verify-gateway-configuration}
...
### 4. Check API Credentials {#4-check-api-credentials}
...
### 5. Test with a Different Gateway {#5-test-with-a-different-gateway}
