...
### 1. Update the Plugin {#1-update-the-plugin}
...
### 2. Enable Auto-Updates {#2-enable-auto-updates}
...
### 3. Manual Update {#3-manual-update}
...
### 4. Check for Update Errors {#4-check-for-update-errors}
...
### 5. Downgrade POS App (Temporary) {#5-downgrade-pos-app-temporary}
