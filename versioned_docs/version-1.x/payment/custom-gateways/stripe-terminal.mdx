...
MOTO only works with the **Stripe Reader S700/S710** and **WisePOS E** readers. The toggle will not appear for other reader types.
...
1. Connect a compatible reader (S700, S710, or WisePOS E)
...
<Accordion>
  ...
  - Make sure you're connected to a compatible reader (S700, S710, or WisePOS E) — the toggle is hidden for other reader types
