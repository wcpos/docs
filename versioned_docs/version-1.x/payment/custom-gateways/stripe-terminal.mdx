...
### Connecting a Reader {#connecting-a-reader}
...
### Phone Orders (MOTO) {#phone-orders-moto}
...
#### Taking a Phone Order {#taking-a-phone-order}
...
### Supported Terminals (Internet-Connected) {#supported-terminals-internet-connected}

- **Stripe Reader S700/S710** ✅ - Ethernet/WiFi-connected terminal
- **WisePOS E** ✅ - WiFi-connected terminal

### Unsupported Terminals (Bluetooth) {#unsupported-terminals-bluetooth}
