...
![Gateway in POS](/img/payment/email-invoice-pos.png)
*Enter customer email address and optionally save to billing information*

![Customer Email](/img/payment/email-invoice-email.png)
*Professional invoice email with order details and payment link*

![Online Payment](/img/payment/email-invoice-payment.png)
*Customer completes payment using your web store's payment methods*