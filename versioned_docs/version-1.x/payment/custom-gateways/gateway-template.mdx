...
<FeatureGrid>
  <FeatureCard icon="code" title="Complete Template">
    Ready-to-use gateway structure with all required methods
  </FeatureCard>
  <FeatureCard icon="store" title="POS Integration">
    Pre-configured for WooCommerce POS compatibility
  </FeatureCard>
  <FeatureCard icon="terminal" title="Automated Setup">
    Script-based template customisation
  </FeatureCard>
  <FeatureCard icon="puzzle-piece" title="Extensible">
    Easy to modify and extend for specific payment providers
  </FeatureCard>
</FeatureGrid>
...
The template includes a script that automatically customises the template for your specific gateway:
...
If you prefer manual customisation:
