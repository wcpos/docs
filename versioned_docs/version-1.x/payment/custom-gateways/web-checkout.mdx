...
description: Complete payments via the web store checkout in WCPOS
---
...
2. Find the **WCPOS Web Checkout Gateway** in the list
...
### Initiating Web Checkout {#initiating-web-checkout}
...
<Accordion>
  <AccordionItem question="Checkout link not working">
  ...
  <AccordionItem question="Order not updating in POS">
  ...
  <AccordionItem question="Customer can't access checkout">
