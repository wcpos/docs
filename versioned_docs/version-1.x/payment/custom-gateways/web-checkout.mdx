...
<RequirementsList>
  ...
  <RequirementItem label="Web Payment Gateways">At least one online payment method configured in WooCommerce</RequirementItem>
  <RequirementItem label="SSL Certificate">HTTPS required for secure payment processing</RequirementItem>
  <RequirementItem label="Modern Browser">Customer device must support modern web standards</RequirementItem>
</RequirementsList>
