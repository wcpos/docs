...
![POS Gateway Selection](/img/payment/web-checkout-pos.png)
*Select Web Checkout gateway and generate payment link for customer*

![Web Checkout Process](/img/payment/web-checkout-online.png)
*Customer completes payment using your web store's checkout system*

![Order Completion](/img/payment/web-checkout-complete.png)
*Return to POS to process receipt after successful online payment*