...
description: Accept phone-based payments via QR code or push notification in WooCommerce POS
---
...
<FeatureGrid>
  ...
  <FeatureCard icon="globe" title="Nordic Coverage">
    Works with Vipps in Norway and Sweden, MobilePay in Denmark and Finland
  </FeatureCard>
...
1. Visit the [Vipps MobilePay for WooCommerce POS releases page](https://github.com/wcpos/woocommerce-pos-vipps/releases)
2. Download the latest **woocommerce-pos-vipps.zip** file
...
2. Find **Vipps MobilePay** in the payment methods list
3. Click on **Vipps MobilePay** to access settings
...
:::note
You do not need to enable the Vipps MobilePay gateway in WooCommerce settings. It will be enabled specifically for the POS in the next step.
:::

:::tip Already using the Vipps plugin?
If you have the official [Vipps/MobilePay for WooCommerce](https://wordpress.org/plugins/vipps-recurring-payments-gateway-for-woocommerce/) plugin installed, your credentials will be imported automatically when you activate this plugin. You can skip the manual credential entry.
:::
...
<RequirementsList>
  ...
  <RequirementItem label="WooCommerce POS">Pro version installed and activated</RequirementItem>
...
- Visit the [GitHub repository](https://github.com/wcpos/woocommerce-pos-vipps) to report issues
