...
<RequirementsList>
  ...
  <RequirementItem label="WooCommerce POS">Pro version required for POS checkout. The gateway also works on the standard WooCommerce web checkout without Pro.</RequirementItem>
