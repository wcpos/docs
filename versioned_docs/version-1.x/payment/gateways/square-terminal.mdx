...
2. On the Square Terminal, open the device-code sign-in screen and enter the code. If the Terminal is currently signed in to Square POS or another integration, sign out of that first — the device-code screen is not reachable while it is in use elsewhere.
...
:::note Why a Terminal you own might not be selectable
...
:::note Not available if you used Connect to Square
