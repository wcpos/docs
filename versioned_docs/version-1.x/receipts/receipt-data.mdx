...
Receipt Data v1.1 adds recorded regular-price, pre-coupon selling-price, and savings fields for each product line. These fields are separate from WooCommerce coupon discounts, so a receipt can show both kinds of reduction without changing order totals or reports.
