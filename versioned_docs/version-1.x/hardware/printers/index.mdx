...
- **Newer models (TM-m30III and similar):** these serve ePOS on port `80` (HTTP) / `443` (HTTPS) instead of 8008/8043 — if the auto-filled port doesn't connect on the web app, set the **Port** to `80` (HTTP store) or `443` (HTTPS store)
