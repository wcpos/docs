...
Not sure where to start? The [**Printer Setup Wizard**](/hardware/printer-setup-wizard) asks a few questions and walks you through connecting your printer step by step — and helps you fix it if the test print doesn't work.
:::
