...
2. **Settings override.** Go to **POS > Settings > Print Routing** to assign a specific printer to each template. For example, route your thermal receipt to the Epson network printer and your HTML invoice to the system print dialog. Set a template back to **Auto** to remove the override.
