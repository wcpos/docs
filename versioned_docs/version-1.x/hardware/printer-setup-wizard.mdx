...
<PrinterWizard>
  ...
  <WizardQuestion id="where" title="Where is the printer, and what do you want to print?">
    ...
    <WizardChoice value="cloud" label="Somewhere else — on another wifi/network" goTo="cloud-provider" />
    <WizardChoice value="cloud-online" label="I want to print every order automatically, including online sales" goTo="cloud-provider" />
  </WizardQuestion>
