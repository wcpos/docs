...
<PrinterWizard>
  ...
  <WizardQuestion id="where" title="Where is the printer, and what do you want to print?">
    <WizardChoice value="local" label="Right here — plugged into or on the same wifi/network as this till" goTo="platform" />
    <WizardChoice value="cloud" label="Somewhere else — on another wifi/network, or connected to another computer" goTo="cloud-provider" />
    <WizardChoice value="cloud-online" label="I want orders to print automatically, including online-store orders" goTo="cloud-provider" />
  </WizardQuestion>
