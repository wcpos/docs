...
- `totals.savings_total`, `totals.savings_total_incl`, `totals.savings_total_excl` — total recorded regular-to-selling-price savings across product lines, including catalogue sale prices and till overrides.
