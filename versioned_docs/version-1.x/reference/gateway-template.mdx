...
description: Create a custom POS-only payment gateway for WCPOS
---
...
1. Go to **WP Admin > WCPOS > Settings > Checkout**
...
## Customising Your Gateway {#customising-your-gateway}

### Adding Payment Fields {#adding-payment-fields}
...
### Changing Payment Behaviour {#changing-payment-behaviour}
...
## Making Changes and Updating {#making-changes-and-updating}
...
### Automated Releases with GitHub {#automated-releases-with-github}
...
<RequirementsList>
  ...
  <RequirementItem label="PHP">Basic PHP knowledge for customising the gateway</RequirementItem>
</RequirementsList>
...
### Example Gateways {#example-gateways}

These existing gateways were built with the same approach and are good references:

- **[Email Invoice](/payment/gateways/email-invoice)** — Sends an invoice email so the customer can pay later
- **[Web Checkout](/payment/gateways/web-checkout)** — Redirects to the web store for payment
