...
Below are two options for selling 'miscellaneous products' in WCPOS.

### POS Only Miscellaneous Product (recommended) {#pos-only-miscellaneous-product-recommended}
...
Using the [POS Only](./pos-only-products) feature, you can create a 'miscellaneous product' for use in the POS.
