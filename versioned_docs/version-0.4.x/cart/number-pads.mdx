---
title: Number Pads
description: WCPOS uses a number of number pad components to allow quick input using the mouse or touch screen.
---

WCPOS uses a number of number pad components to allow quick input using the mouse or touch screen.
