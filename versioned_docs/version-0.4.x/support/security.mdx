...
### Don't leave your POS unattended {#dont-leave-your-pos-unattended}
...
- Log out of WordPress and WCPOS when you leave your device
- Reset your passwords quickly in the event that your device is stolen
- Remote wipe your device in the event it is stolen

### Use the least number of plugins possible {#use-the-least-number-of-plugins-possible}
