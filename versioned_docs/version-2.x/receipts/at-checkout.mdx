...
<LinkCards>
  <LinkCard to="/receipts" title="Receipt Templates" description="Customise receipt appearance" />
  <LinkCard to="/receipts/cloud-printing" title="Cloud Printing" description="Print to Star, Epson, and PrintNode printers" />
