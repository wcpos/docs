...
sidebar_position: 1
description: Troubleshoot slow checkout times in WCPOS by analysing execution times and identifying bottlenecks.
---
...
## How WCPOS Checkout Works {#how-wcpos-checkout-works}
...
### 1. Unnecessary Scripts and Styles {#1-unnecessary-scripts-and-styles}
...
### 2. Plugin Interference During Order Creation {#2-plugin-interference-during-order-creation}
...
### 3. Server Resource Limitations {#3-server-resource-limitations}
...
## WordPress Developer Best Practices {#wordpress-developer-best-practices}
...
<LinkCards>
  <LinkCard to="/pos/checkout#checkout-settings-troubleshooting" title="Checkout Settings" description="Disable problematic scripts and styles" />
  <LinkCard to="/payment" title="Payment Methods" description="Configure payment gateways for optimal performance" />
