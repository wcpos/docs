...
:::note Completing a sale needs a connection
You can build and **save** an order offline, but the payment step itself waits for a connection. Being able to *complete* a sale offline — starting with cash — is on the [roadmap](/getting-started/roadmap).
:::
