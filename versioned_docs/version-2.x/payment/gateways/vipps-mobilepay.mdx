...
### Processing Payments — QR Code {#processing-payments--qr-code}
...
### Processing Payments — Send to Phone {#processing-payments--send-to-phone}
...
### Enabling Direct Push {#enabling-direct-push}
