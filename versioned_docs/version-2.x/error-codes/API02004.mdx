...
### 2. Enable POS Access {#2-enable-pos-access}
...
### 3. Request Additional Permissions {#3-request-additional-permissions}
...
### 4. Check Store Assignment {#4-check-store-assignment}
