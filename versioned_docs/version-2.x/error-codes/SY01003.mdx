...
### 1. Run as Administrator (Windows) {#1-run-as-administrator-windows}

Right-click the app and select "Run as administrator" if needed for initial setup.

### 2. Check Application Permissions {#2-check-application-permissions}
...
### 3. Check Folder Permissions {#3-check-folder-permissions}
...
### 4. Review Antivirus Settings {#4-review-antivirus-settings}
...
### 5. Reinstall the Application {#5-reinstall-the-application}
...
## Browser Permissions (Web Version) {#browser-permissions-web-version}
