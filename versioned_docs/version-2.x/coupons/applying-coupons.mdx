...
- **Completing the sale can work offline** with an offline-capable payment method. The order queues locally; the server re-validates the coupon and updates its usage count when the order reaches WooCommerce.
